...
const CONCEPT_PROTOCOLS = [
  {
    ...
    highlight: "",
    definition: "Objective: How is Rushi related to Jay?",
    logicPoints: [
      "SCENARIO: Jay introduces Rushi as the husband of the only granddaughter of his mother. (Jay has no siblings).",
      "GOLDEN RULE: Always start at the possessive word 'his/my' and work backwards piece by piece.",
  ...
  },
  {
    ...
    highlight: "his mother",
    definition: "Sentence: ...of his mother.",
    logicPoints: [
      "ANCHOR: Start with the speaker/subject, Jay.",
      "PHRASE: 'his mother' refers to Jay's direct parent.",
      "ACTION: Place 'Mother' strictly vertical, directly above Jay."
    ],
  ...
  },
  {
    ...
    highlight: "only granddaughter of his mother",
    definition: "Sentence: ...the only granddaughter of his mother.",
    logicPoints: [
      "PHRASE: The 'granddaughter' of Jay's mother.",
      "CRITICAL CLUE: We know Jay has no siblings.",
      "DEDUCTION: If his mother has a granddaughter and Jay is the only child, the granddaughter MUST be Jay's own daughter!",
      "ACTION: Place 'Daughter' strictly vertical below Jay."
    ],
  ...
  },
  {
    ...
    highlight: "husband of the only granddaughter",
    definition: "Sentence: ...the husband of the only granddaughter...",
    logicPoints: [
      "PHRASE: The 'husband of' the node we just placed (Jay's Daughter).",
      "ACTION: Place 'Husband' next to Daughter with a Marriage Bond (=).",
      "We have now mapped the entire relational chain."
    ],
  ...
  },
  {
    ...
    tab: "Step 4",
    title: "Conclusion",
    highlight: "Jay introduces Rushi as the husband",
    definition: "Sentence: Jay introduces Rushi as the husband...",
    logicPoints: [
      "We know the husband of Jay's daughter is the target of the introduction.",
      "The target is Rushi.",
      "FINAL DEDUCTION: Rushi is married to Jay's daughter. Therefore, Rushi is Jay's Son-in-Law!"
    ],
...
const PRACTICE_TASKS = [
  {
    mission: "Trial 1: Pointing to a Girl",
    expression: "Pointing to a girl (B), Aman (A) says, 'She is the daughter of my father's only son.'",
    objective: "How is the girl (B) related to Aman (A)?",
    characters: [
      { id: 'FATH', gender: 'M' },
      { id: 'A', gender: 'M' },
      { id: 'B', gender: 'F' }
    ...
    clues: [
      "Start at 'my father' (Aman's father).",
      "Who is the 'only son' of Aman's father? It must be Aman (A) himself!",
    ...
    followUp: {
      ...
      correct: 1,
      explanation: "Aman is the only son of his father. The daughter of Aman is logically Aman's own Daughter."
    }
  },
  {
    mission: "Trial 2: Pointing to a Boy",
    expression: "Pointing to a boy (N), a man (M) says, 'He is the son of the only daughter of my mother.'",
    objective: "How is the boy (N) related to the man (M)?",
    characters: [
      { id: 'MOTH', gender: 'F' },
      { id: 'M', gender: 'M' },
      { id: 'SIS', gender: 'F' },
    ...
    clues: [
      ...
      "The boy (N) is the son of M's sister."
    ],
  ...
  {
    mission: "Trial 3: Pointing to a Woman",
    expression: "Pointing to a woman (Q), Paul (P) says, 'She is the wife of the grandson of my mother.'",
    objective: "How is the woman (Q) related to Paul (P)?",
    characters: [
      { id: 'MOTH', gender: 'F' },
      { id: 'P', gender: 'M' },
      { id: 'SON', gender: 'M' },
    ...
    clues: [
      "Start at 'my mother' -> P's mother.",
      "The 'grandson' of P's mother -> P's son.",
      "The woman (Q) is the wife of P's son."
    ],
  ...
  {
    mission: "Trial 4: The Photograph",
    expression: "Looking at a portrait of a man (B), a woman (W) says, 'He is the brother of the daughter of the wife of my husband.'",
    objective: "How is the man (B) related to the woman (W)?",
    characters: [
      { id: 'HUSB', gender: 'M' },
      { id: 'W', gender: 'F' },
      { id: 'DAU', gender: 'F' },
    ...
    clues: [
      ...
      "The man (B) is the brother of W's daughter."
    ],
  ...
  },
  {
    ...
    expression: "X introduces Y saying, 'He is the husband of the granddaughter of the father of my father.'",
                ...
                <div className="absolute top-2 sm:top-4 left-1/2 -translate-x-1/2 z-50 flex flex-col items-center gap-1 bg-[#1a110f] px-3 py-1.5 sm:px-5 sm:py-2.5 rounded-xl sm:rounded-2xl border border-white/10 shadow-2xl w-11/12 max-w-[340px] sm:max-w-[580px]">
                    <div className="flex items-center gap-1 sm:gap-2 text-emerald-400">
                        ...
                        <span className="text-[8px] sm:text-[10px] uppercase tracking-[0.2em] font-black text-center">
                            {appMode === 'concept' ? "How is Rushi related to Jay?" : PRACTICE_TASKS[practiceStep].objective}
                        </span>
                    </div>
                    <div className="w-full h-[1px] bg-white/10 my-0.5 sm:my-1"></div>
                    <span className="font-mono text-[8px] sm:text-[10px] lg:text-sm text-white font-bold tracking-wide flex items-center text-center leading-tight">
                      {appMode === 'concept' ? (
                         CONCEPT_PROTOCOLS[activeTab].tab === "Objective" 
                            ? <span className="text-emerald-400">"Jay introduces Rushi as the husband of the only granddaughter of his mother."</span>
                            : <HighlightedString fullString="Jay introduces Rushi as the husband of the only granddaughter of his mother." highlight={CONCEPT_PROTOCOLS[activeTab].highlight} />
                      ) : (
    ...
    if (data.type === 'step-build') {
        ...
        return (
            <div className="relative w-[90%] h-[90%] shrink-0 flex items-center justify-center">
                {step >= 1 && <motion.div layout className="absolute top-[15%] left-[50%] -translate-x-1/2 -translate-y-1/2 z-10">
                    <Node data={{id:'MOM', g:'F'}} color="bg-stone-600" isExtraSmall />
                </motion.div>}
                
                {step >= 1 && <motion.div layout className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 z-10">
                    <Node data={{id:'JAY', g:'M'}} color="bg-blue-600" isExtraSmall />
                </motion.div>}

                {step >= 2 && <motion.div layout className={`absolute top-[85%] -translate-x-1/2 -translate-y-1/2 z-10 transition-all duration-700 ease-in-out ${step >= 3 ? 'left-[35%]' : 'left-[50%]'}`}>
                    <Node data={{id:'DAU', g:'F'}} color="bg-purple-600" isExtraSmall />
                </motion.div>}
                
                {step >= 3 && <motion.div layout className="absolute top-[85%] left-[65%] -translate-x-1/2 -translate-y-1/2 z-10">
                    <Node data={{id: step >= 4 ? 'RUSHI' : 'HUSB', g:'M'}} color={step >= 4 ? "bg-emerald-600" : "bg-stone-600"} isExtraSmall />
                </motion.div>}
                ...
                <svg className="absolute inset-0 w-full h-full pointer-events-none z-0 overflow-visible" viewBox="0 0 100 100" preserveAspectRatio="none">
                    ...
                    {step === 2 && <>
                        {/* Straight drop JAY to DAU */}
                        <line x1="50" y1="50" x2="50" y2="80" stroke="#facc15" strokeWidth="1.5" />
                        <polygon points="47.5,77 52.5,77 50,81" fill="#facc15" />
                    </>}

                    {step >= 3 && <>
                        {/* Split drop JAY to DAU */}
                        <path d="M 50 50 V 65 H 35 V 80" stroke="#facc15" strokeWidth="1.5" fill="none" />
                        <polygon points="32.5,77 37.5,77 35,81" fill="#facc15" />
                        
                        {/* DAU = HUSB Marriage */}
                        <line x1="35" y1="83" x2="65" y2="83" stroke="#facc15" strokeWidth="1.5" opacity="0.6" />
                        <line x1="35" y1="87" x2="65" y2="87" stroke="#facc15" strokeWidth="1.5" opacity="0.6" />
                    </>}
                </svg>

                {step >= 3 && <div className="absolute top-[85%] left-[50%] -translate-x-1/2 -translate-y-1/2 z-20 bg-[#1a110f] rounded-full p-[2px] border border-white/5 shadow-inner">
