...
const CONCEPT_PROTOCOLS = [
  {
    id: "pattern-parent",
    tab: "Pattern 1",
    title: "The Parent Pattern",
    definition: "Sentence: 'Ravi is the father of Sita.'",
    logicPoints: [
      "KEYWORD: 'father of' indicates a direct vertical drop.",
      "GENDER: Ravi is explicitly stated as Male (M).",
      "PLACEMENT: The subject (Ravi) goes on top, object (Sita) goes below."
    ],
    visual: { type: 'sentence-parent', top: {id:'RAVI', g:'M'}, btm: {id:'SITA', g:'F'} }
  },
  {
    id: "pattern-sibling",
    tab: "Pattern 2",
    title: "The Sibling Pattern",
    definition: "Sentence: 'Sita is the sister of Mohan.'",
    logicPoints: [
      "KEYWORD: 'sister of' indicates a horizontal sibling line.",
      "GENDER: Sita is explicitly stated as Female (F).",
      "PLACEMENT: They share the exact same generational tier."
    ],
    visual: { type: 'sentence-sibling', left: {id:'SITA', g:'F'}, right: {id:'MOHAN', g:'M'} }
  },
  {
    id: "pattern-marriage",
    tab: "Pattern 3",
    title: "The Marriage Pattern",
    definition: "Sentence: 'Mohan is married to Gita.'",
    logicPoints: [
      "KEYWORD: 'married to' triggers the double line with a heart.",
      "GENDER: If Mohan is a Male (M) brother, his spouse Gita is Female (F).",
      "PLACEMENT: Spouses sit side-by-side on the same horizontal tier."
    ],
    visual: { type: 'sentence-marriage', left: {id:'MOHAN', g:'M'}, right: {id:'GITA', g:'F'} }
  },
  {
    id: "pattern-chain",
    tab: "Pattern 4",
    title: "The Chain Pattern",
    definition: "Sentence: 'Ravi is the father of Mohan, who is the father of Arjun.'",
    logicPoints: [
      "KEYWORD: 'who is' links the second phrase back to Mohan.",
      "FLOW: Creates two consecutive vertical drops (-2 tiers).",
      "DEDUCTION: We can mathematically deduce Ravi is Arjun's grandfather."
    ],
    visual: { type: 'sentence-chain', top: {id:'RAVI', g:'M'}, mid: {id:'MOHAN', g:'M'}, btm: {id:'ARJUN', g:'M'} }
  }
];

const PRACTICE_TASKS = [
  {
    mission: "Trial 1: Simple Lineage",
    clues: [
    ...
    slots: [
      { id: 0, expectedId: 'AMIT', label: 'Top Tier' },
      { id: 1, expectedId: 'NEHA', label: 'Bottom Tier' }
    ],
    followUp: {
      q: "If Neha has a child named Raj, how would Amit be related to Raj?",
      options: ["Uncle", "Grandfather", "Father"],
      correct: 1,
      explanation: "Raj would sit one tier below Neha, making him two tiers below Amit. A two-tier gap upwards defines a Grandfather relationship."
    }
  },
  {
    mission: "Trial 2: Sibling Bond",
    clues: [
      "Neha is the sister of Rahul."
    ],
    characters: [
      { id: 'RAHUL', gender: '?' },
      { id: 'NEHA', gender: 'F' }
    ...
    slots: [
      { id: 0, expectedId: 'NEHA', label: 'Node 1' },
      { id: 1, expectedId: 'RAHUL', label: 'Node 2' }
    ],
    followUp: {
      q: "Based strictly on the sentence 'Neha is the sister of Rahul', do we know Rahul's exact gender?",
      options: ["Yes, he is a Male", "No, his gender is unknown", "Yes, he is Female"],
      correct: 1,
      explanation: "The sentence only defines Neha as a sister. Rahul could be a brother OR a sister. We must never assume gender from a name alone in these puzzles."
    }
  },
  {
    mission: "Trial 3: Marital Bond",
    clues: [
      "Rahul is the husband of Priya."
    ],
    characters: [
      { id: 'PRIYA', gender: 'F' },
      { id: 'RAHUL', gender: 'M' }
    ...
    slots: [
      { id: 0, expectedId: 'RAHUL', label: 'Node 1' },
      { id: 1, expectedId: 'PRIYA', label: 'Node 2' }
    ],
    followUp: {
      q: "If Rahul is the brother of Neha, how is Priya related to Neha?",
      options: ["Sister", "Sister-in-law", "Cousin"],
      correct: 1,
      explanation: "Priya is married to Neha's brother (Rahul). In family logic, your sibling's spouse is your Sister-in-law."
    }
  },
  {
    mission: "Trial 4: Lineage Chain",
    clues: [
      "Amit is the father of Rahul, who is the father of Yash."
    ],
    characters: [
      { id: 'YASH', gender: 'M' },
      { id: 'AMIT', gender: 'M' },
    ...
    slots: [
      { id: 0, expectedId: 'AMIT', label: 'Tier +2' },
      { id: 1, expectedId: 'RAHUL', label: 'Tier +1' },
      { id: 2, expectedId: 'YASH', label: 'Tier 0' }
    ],
    followUp: {
      q: "If Yash is Male, what is his specific relationship to Amit?",
      options: ["Son", "Nephew", "Grandson"],
      correct: 2,
      explanation: "Yash sits exactly two tiers below Amit. As a male descendant with a two-tier gap, Yash is the Grandson."
    }
  },
  {
    mission: "Trial 5: Complex Deduction",
    clues: [
      "Yash is the only son of Rahul.",
      "Amit is the paternal grandfather of Yash."
    ],
    characters: [
      { id: 'YASH', gender: 'M' },
      { id: 'AMIT', gender: 'M' },
    ...
    followUp: {
      q: "Based on the arrangement you constructed, what is the relationship between Rahul and Amit?",
      options: ["Rahul is Amit's brother", "Rahul is Amit's father", "Rahul is Amit's son"],
      correct: 2,
      explanation: "Since Amit is the paternal grandfather of Yash, Amit must be the father of Yash's father (Rahul). Thus, Rahul is the son of Amit."
    }
  }
];
...
function TreeVisual({ data }) {
    if (data.type === 'sentence-parent') return (
      <div className="flex flex-col items-center gap-2 bg-[#1a110f] p-12 rounded-full border border-white/5 shadow-inner min-w-[340px] sm:min-w-[480px] h-[480px] justify-center relative overflow-hidden">
        ...
        <Node data={data.btm} color="bg-purple-600" isSmall />
      </div>
    );
    ...
    if (data.type === 'sentence-sibling') return (
      <div className="flex flex-col items-center gap-2 bg-[#1a110f] p-12 rounded-full border border-white/5 shadow-inner min-w-[340px] sm:min-w-[480px] h-[480px] justify-center relative overflow-hidden">
        <div className="flex items-center gap-16 sm:gap-24">
            ...
            <Node data={data.right} color="bg-blue-600" isSmall />
        </div>
      </div>
    );
    ...
    if (data.type === 'sentence-chain') return (
      <div className="flex flex-col items-center gap-2 bg-[#1a110f] p-12 rounded-full border border-white/5 shadow-inner min-w-[340px] sm:min-w-[480px] h-[520px] justify-center relative overflow-hidden">
        ...
        <Node data={data.btm} color="bg-blue-600" isSmall />
      </div>
    );
