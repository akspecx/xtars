...
const CONCEPT_PROTOCOLS = [
  {
    id: "uncle",
    tab: "Uncle",
    title: "Extended Protocol: Uncle",
    definition: "An Uncle is the brother of your parent (either Father or Mother).",
    logicPoints: [
      "SIBLING BOND: Uncle sits on the same tier as your parent.",
      "GENDER: Uncle is always Male (M).",
      "LOGIC: Trace up to Parent, then across to Uncle."
    ],
    visual: { 
      type: 'dual-case-uncle-aunt-flow', 
      case1: { title: "PATERNAL UNCLE", topleft: {id:'FATHER', g:'M'}, botleft: {id:'ME', g:'?'}, topright: {id:'UNCLE', g:'M'}, hLabel: 'BROTHER', vLabel: 'FATHER', logicLabel: 'UNCLE' },
      case2: { title: "MATERNAL UNCLE", topleft: {id:'MOTHER', g:'F'}, botleft: {id:'ME', g:'?'}, topright: {id:'UNCLE', g:'M'}, hLabel: 'BROTHER', vLabel: 'MOTHER', logicLabel: 'UNCLE' }
    }
  },
  {
    id: "aunt",
    tab: "Aunt",
    title: "Extended Protocol: Aunt",
    definition: "An Aunt is the sister of your parent (either Father or Mother).",
    logicPoints: [
      "SIBLING BOND: Aunt sits on the same tier as your parent.",
      "GENDER: Aunt is always Female (F).",
      "LOGIC: Trace up to Parent, then across to Aunt."
    ],
    visual: { 
      type: 'dual-case-uncle-aunt-flow', 
      case1: { title: "PATERNAL AUNT", topleft: {id:'FATHER', g:'M'}, botleft: {id:'ME', g:'?'}, topright: {id:'AUNT', g:'F'}, hLabel: 'SISTER', vLabel: 'FATHER', logicLabel: 'AUNT' },
      case2: { title: "MATERNAL AUNT", topleft: {id:'MOTHER', g:'F'}, botleft: {id:'ME', g:'?'}, topright: {id:'AUNT', g:'F'}, hLabel: 'SISTER', vLabel: 'MOTHER', logicLabel: 'AUNT' }
    }
  },
  {
    id: "cousin",
    tab: "Cousins",
    title: "Extended Protocol: Cousin",
    definition: "A Cousin is the child of your Uncle or Aunt.",
    logicPoints: [
      "GENERATION: Cousins sit on the exact same generation tier as you.",
      "PATH: Parent ⤏ Uncle/Aunt ⬇ Cousin.",
      "GENDER: Cousin can be Male (M) or Female (F)."
    ],
    visual: { 
      type: 'dual-case-cousin-flow', 
      case1: { title: "UNCLE'S CHILD", topleft: {id:'PARENT', g:'?'}, botleft: {id:'ME', g:'?'}, topright: {id:'UNCLE', g:'M'}, botright: {id:'COUSIN', g:'?'}, hLabel: 'BROTHER', v1Label: 'PARENT', v2Label: 'SON', logicLabel: 'COUSIN' },
      case2: { title: "AUNT'S CHILD", topleft: {id:'PARENT', g:'?'}, botleft: {id:'ME', g:'?'}, topright: {id:'AUNT', g:'F'}, botright: {id:'COUSIN', g:'?'}, hLabel: 'SISTER', v1Label: 'PARENT', v2Label: 'DAUGHTER', logicLabel: 'COUSIN' }
    }
  }
];
...
const PRACTICE_TASKS = [
  {
    mission: "Trial 1: Paternal Uncle. 'F is your father. U is the brother of F.'",
    clues: [
      "Rule 1: F is your father (F sits above ME).",
      "Rule 2: U is the brother of F (U is horizontal to F).",
      "Rule 3: U is a Male (M)."
    ],
    characters: [
      { id: 'F', gender: 'M', label: 'FATHER' },
      { id: 'ME', gender: '?', label: 'YOU' },
      { id: 'U', gender: 'M', label: 'BROTHER' }
    ],
    template: 'practice-uncle',
    slots: [
      { id: 0, expectedId: 'F', label: 'Parent' },
      { id: 1, expectedId: 'ME', label: 'Me' },
      { id: 2, expectedId: 'U', label: 'Parent Sibling' }
    ],
    labels: { vLabel: 'FATHER', hLabel: 'BROTHER' },
    followUp: {
      q: "What is the specific relationship of U to ME?",
      options: ["Grandfather", "Paternal Uncle", "Maternal Uncle"],
      correct: 1,
      explanation: "Since U is the brother of your FATHER, U is your Paternal Uncle."
    }
  },
  {
    mission: "Trial 2: Maternal Aunt. 'M is your mother. A is the sister of M.'",
    clues: [
      "Rule 1: M is your mother (M sits above ME).",
      "Rule 2: A is the sister of M (A is horizontal to M).",
      "Rule 3: A is a Female (F)."
    ],
    characters: [
      { id: 'M', gender: 'F', label: 'MOTHER' },
      { id: 'ME', gender: '?', label: 'YOU' },
      { id: 'A', gender: 'F', label: 'SISTER' }
    ],
    template: 'practice-uncle',
    slots: [
      { id: 0, expectedId: 'M', label: 'Parent' },
      { id: 1, expectedId: 'ME', label: 'Me' },
      { id: 2, expectedId: 'A', label: 'Parent Sibling' }
    ],
    labels: { vLabel: 'MOTHER', hLabel: 'SISTER' },
    followUp: {
      q: "What is the specific relationship of A to ME?",
      options: ["Paternal Aunt", "Maternal Aunt", "Cousin"],
      correct: 1,
      explanation: "Since A is the sister of your MOTHER, A is your Maternal Aunt."
    }
  },
  {
    mission: "Trial 3: First Cousin. 'P is your parent. U is P's brother. C is U's son.'",
    clues: [
      "Rule 1: P is your parent (above ME).",
      "Rule 2: U is the brother of P (horizontal to P).",
      "Rule 3: C is the son of U (below U, Male)."
    ],
    characters: [
      { id: 'P', gender: '?', label: 'PARENT' },
      { id: 'ME', gender: '?', label: 'YOU' },
      { id: 'U', gender: 'M', label: 'UNCLE' },
      { id: 'C', gender: 'M', label: 'SON' }
    ],
    template: 'practice-cousin',
    slots: [
      { id: 0, expectedId: 'P', label: 'Parent' },
      { id: 1, expectedId: 'ME', label: 'Me' },
      { id: 2, expectedId: 'U', label: 'Uncle' },
      { id: 3, expectedId: 'C', label: 'Cousin' }
    ],
    labels: { v1Label: 'PARENT', hLabel: 'BROTHER', v2Label: 'SON' },
    followUp: {
      q: "On which generational tier does Cousin C sit relative to ME?",
      options: ["One tier above (+1)", "The exact same tier (0)", "One tier below (-1)"],
      correct: 1,
      explanation: "Cousins share the exact same generational level as you, mapping horizontally across the bottom tier."
    }
  },
  {
    mission: "Trial 4: Cousin Trace. 'M is your mother's sister. D is M's daughter.'",
    clues: [
      "Rule 1: M is your Aunt (horizontal to Parent).",
      "Rule 2: D is the daughter of M (below M).",
      "Rule 3: D is Female (F)."
    ],
    characters: [
      { id: 'P', gender: 'F', label: 'MOTHER' },
      { id: 'ME', gender: '?', label: 'YOU' },
      { id: 'M', gender: 'F', label: 'AUNT' },
      { id: 'D', gender: 'F', label: 'DAUGHTER' }
    ],
    template: 'practice-cousin',
    slots: [
      { id: 0, expectedId: 'P', label: 'Parent' },
      { id: 1, expectedId: 'ME', label: 'Me' },
      { id: 2, expectedId: 'M', label: 'Aunt' },
      { id: 3, expectedId: 'D', label: 'Cousin' }
    ],
    labels: { v1Label: 'MOTHER', hLabel: 'SISTER', v2Label: 'DAUGHTER' },
    followUp: {
      q: "How is D related to ME?",
      options: ["Niece", "Sister", "Cousin"],
      correct: 2,
      explanation: "D is the child of your Aunt (M). The child of an Aunt or Uncle is always a Cousin."
    }
  }
];
                ...
                {!lessonFinished ? (
                  ...
                  <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="flex flex-col items-center gap-8 text-center p-6 sm:p-10 w-full">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 w-full justify-center max-w-lg mt-6">
                        ...
                        <button onClick={() => navigate('/learn/logicalReasoning/bloodRelations/brWorkingWithInstructions')} className="flex-1 bg-amber-400 text-black border-b-8 border-amber-600 px-6 py-4 rounded-2xl font-black uppercase text-sm sm:text-base shadow-xl hover:scale-105 transition-all">
                            Next Module
                        </button>
                    </div>
                  </motion.div>
                  ...
                  {!lessonFinished ? (
                    appMode === 'concept' ? (
                      <motion.div key="academy-tabs" className="w-full h-full flex flex-col gap-4">
                         <div className="grid grid-cols-3 sm:grid-cols-3 gap-1.5 bg-black/40 p-1.5 rounded-xl border border-white/5">
...
function TreeVisual({ data }) {
    if (data.type === 'dual-case-uncle-aunt-flow') return (
      <div className="flex flex-col sm:flex-row gap-8 sm:gap-16 items-center overflow-x-auto w-full justify-center px-4">
        {[data.case1, data.case2].map((c, i) => (
          <div key={i} className="flex flex-col items-center bg-[#1a110f] p-12 rounded-full border border-white/5 shadow-inner min-w-[340px] sm:min-w-[480px] h-[480px] sm:h-[540px] justify-center relative overflow-hidden shrink-0">
            ...
            <div className="relative w-[260px] sm:w-[300px] aspect-square mt-4 sm:mt-12 shrink-0">
                <div className="absolute top-0 left-0 w-[110px] h-[110px] flex items-center justify-center z-10">
                    <Node data={c.topleft} color={i === 0 ? "bg-blue-600" : "bg-purple-600"} isSmall />
                </div>
                <div className="absolute top-0 right-0 w-[110px] h-[110px] flex items-center justify-center z-10">
                    <Node data={c.topright} color={c.topright.g === 'M' ? "bg-blue-600" : "bg-purple-600"} isSmall />
                </div>
                <div className="absolute bottom-0 left-0 w-[110px] h-[110px] flex items-center justify-center z-10">
                    <Node data={c.botleft} color="bg-stone-600" isSmall />
                </div>
                ...
                <svg className="absolute inset-0 w-full h-full pointer-events-none z-0" viewBox="0 0 300 300" preserveAspectRatio="xMidYMid meet">
                    ...
                    <line x1="115" y1="55" x2="185" y2="55" stroke="#facc15" strokeWidth="2.5" strokeDasharray="6 6" />
                    {c.hLabel && <text className="font-sans" x="150" y="45" fill="#fbbf24" fontSize="11" fontWeight="900" textAnchor="middle" stroke="#1a110f" strokeWidth="4" paintOrder="stroke">{c.hLabel}</text>}
                    
                    {/* Vertical Arrow */}
                    <line x1="55" y1="115" x2="55" y2="185" stroke="#facc15" strokeWidth="2.5" />
                    <polygon points="48,183 62,183 55,193" fill="#facc15" />
                    {c.vLabel && <text className="font-sans" x="65" y="150" fill="#fbbf24" fontSize="11" fontWeight="900" textAnchor="start" dominantBaseline="central" stroke="#1a110f" strokeWidth="4" paintOrder="stroke">{c.vLabel}</text>}
                    
                    {/* Dotted Logic Line Me -> Uncle/Aunt */}
                    <path d="M 115 245 L 245 245 L 245 125" fill="none" stroke="#fbbf24" strokeWidth="2.5" strokeDasharray="8 8" />
                    <polygon points="238,132 252,132 245,122" fill="#fbbf24" />
                    {c.logicLabel && <text className="font-sans" x="180" y="235" fill="#fbbf24" fontSize="11" fontWeight="900" textAnchor="middle" stroke="#1a110f" strokeWidth="4" paintOrder="stroke">{c.logicLabel}</text>}
                </svg>
            </div>
          </div>
        ))}
    ...
    if (data.type === 'dual-case-cousin-flow') return (
        <div className="flex flex-col sm:flex-row gap-8 sm:gap-16 items-center overflow-x-auto w-full justify-center px-4">
          {[data.case1, data.case2].map((c, i) => (
            <div key={i} className="flex flex-col items-center bg-[#1a110f] p-12 rounded-full border border-white/5 shadow-inner min-w-[340px] sm:min-w-[480px] h-[480px] sm:h-[540px] justify-center relative overflow-hidden shrink-0">
              <span className="text-amber-400 font-black uppercase text-[10px] tracking-widest mb-10 text-center absolute top-12">{c.title}</span>
              ...
              <div className="relative w-[260px] sm:w-[300px] aspect-square mt-4 sm:mt-12 shrink-0">
                  <div className="absolute top-0 left-0 w-[110px] h-[110px] flex items-center justify-center z-10">
                      <Node data={c.topleft} color="bg-stone-600" isSmall />
                  </div>
                  <div className="absolute top-0 right-0 w-[110px] h-[110px] flex items-center justify-center z-10">
                      <Node data={c.topright} color={c.topright.g === 'M' ? "bg-blue-600" : "bg-purple-600"} isSmall />
                  </div>
                  <div className="absolute bottom-0 left-0 w-[110px] h-[110px] flex items-center justify-center z-10">
                      <Node data={c.botleft} color="bg-indigo-600" isSmall />
                  </div>
                  <div className="absolute bottom-0 right-0 w-[110px] h-[110px] flex items-center justify-center z-10">
                      <Node data={c.botright} color="bg-stone-600" isSmall />
                  </div>
                  ...
                  <svg className="absolute inset-0 w-full h-full pointer-events-none z-0" viewBox="0 0 300 300" preserveAspectRatio="xMidYMid meet">
                      ...
                      <line x1="55" y1="115" x2="55" y2="185" stroke="#facc15" strokeWidth="2.5" />
                      <polygon points="48,183 62,183 55,193" fill="#facc15" />
                      {c.v1Label && <text className="font-sans" x="65" y="150" fill="#fbbf24" fontSize="11" fontWeight="900" textAnchor="start" dominantBaseline="central" stroke="#1a110f" strokeWidth="4" paintOrder="stroke">{c.v1Label}</text>}
                      
                      {/* Vertical Arrow 2 */}
                      <line x1="245" y1="115" x2="245" y2="185" stroke="#facc15" strokeWidth="2.5" />
                      <polygon points="238,183 252,183 245,193" fill="#facc15" />
                      {c.v2Label && <text className="font-sans" x="235" y="150" fill="#fbbf24" fontSize="11" fontWeight="900" textAnchor="end" dominantBaseline="central" stroke="#1a110f" strokeWidth="4" paintOrder="stroke">{c.v2Label}</text>}
                      
                      {/* Dotted Logic Line Me -> Cousin */}
                      <line x1="115" y1="245" x2="180" y2="245" stroke="#fbbf24" strokeWidth="2.5" strokeDasharray="8 8" />
                      <polygon points="173,238 173,252 183,245" fill="#fbbf24" />
                      {c.logicLabel && <text className="font-sans" x="150" y="235" fill="#fbbf24" fontSize="11" fontWeight="900" textAnchor="middle" stroke="#1a110f" strokeWidth="4" paintOrder="stroke">{c.logicLabel}</text>}
                  </svg>
              </div>
            </div>
          ))}
        ...
        return (
            <div className="relative w-[260px] sm:w-[300px] aspect-square mt-4 sm:mt-12 shrink-0">
                ...
                <svg className="absolute inset-0 w-full h-full pointer-events-none z-0" viewBox="0 0 300 300" preserveAspectRatio="xMidYMid meet">
                    {/* Sibling Line */}
                    <line x1="115" y1="55" x2="185" y2="55" stroke="#facc15" strokeWidth="2.5" strokeDasharray="6 6" />
                    {task.labels?.hLabel && <text className="font-sans" x="150" y="45" fill="#fbbf24" fontSize="11" fontWeight="900" textAnchor="middle" stroke="#1a110f" strokeWidth="4" paintOrder="stroke">{task.labels.hLabel}</text>}
                    
                    {/* Vertical Arrow */}
                    <line x1="55" y1="115" x2="55" y2="185" stroke="#facc15" strokeWidth="2.5" />
                    <polygon points="48,183 62,183 55,193" fill="#facc15" />
                    {task.labels?.vLabel && <text className="font-sans" x="65" y="150" fill="#fbbf24" fontSize="11" fontWeight="900" textAnchor="start" dominantBaseline="central" stroke="#1a110f" strokeWidth="4" paintOrder="stroke">{task.labels.vLabel}</text>}

                    {/* Ghost Dotted Logic Line Me -> Uncle/Aunt */}
                    <path d="M 115 245 L 245 245 L 245 125" fill="none" stroke="#fbbf24" strokeWidth="2.5" strokeDasharray="8 8" opacity="0.2" />
                    <polygon points="238,132 252,132 245,122" fill="#fbbf24" opacity="0.2" />
                    <text className="font-sans" x="180" y="235" fill="#fbbf24" fontSize="18" fontWeight="900" textAnchor="middle" stroke="#1a110f" strokeWidth="4" paintOrder="stroke" opacity="0.5">?</text>
                </svg>
            </div>
        );
    }
    
    if (template === 'practice-cousin') {
        return (
            <div className="relative w-[260px] sm:w-[300px] aspect-square mt-4 sm:mt-12 shrink-0">
                <div className="absolute top-0 left-0 w-[110px] h-[110px] flex items-center justify-center z-10">
                    <Slot data={slots[0]} placedId={placedItems[0]} characters={characters} onRemove={() => onRemove(0)} showRemove={showRemove} isSmall />
                ...
                <svg className="absolute inset-0 w-full h-full pointer-events-none z-0" viewBox="0 0 300 300" preserveAspectRatio="xMidYMid meet">
                    ...
                    <line x1="55" y1="115" x2="55" y2="185" stroke="#facc15" strokeWidth="2.5" />
                    <polygon points="48,183 62,183 55,193" fill="#facc15" />
                    {task.labels?.v1Label && <text className="font-sans" x="65" y="150" fill="#fbbf24" fontSize="11" fontWeight="900" textAnchor="start" dominantBaseline="central" stroke="#1a110f" strokeWidth="4" paintOrder="stroke">{task.labels.v1Label}</text>}
                    
                    {/* Vertical Arrow 2 */}
                    <line x1="245" y1="115" x2="245" y2="185" stroke="#facc15" strokeWidth="2.5" />
                    <polygon points="238,183 252,183 245,193" fill="#facc15" />
                    {task.labels?.v2Label && <text className="font-sans" x="235" y="150" fill="#fbbf24" fontSize="11" fontWeight="900" textAnchor="end" dominantBaseline="central" stroke="#1a110f" strokeWidth="4" paintOrder="stroke">{task.labels.v2Label}</text>}

                    {/* Ghost Dotted Logic Line Me -> Cousin */}
                    <line x1="115" y1="245" x2="180" y2="245" stroke="#fbbf24" strokeWidth="2.5" strokeDasharray="8 8" opacity="0.2" />
                    <polygon points="173,238 173,252 183,245" fill="#fbbf24" opacity="0.2" />
                    <text className="font-sans" x="150" y="235" fill="#fbbf24" fontSize="18" fontWeight="900" textAnchor="middle" stroke="#1a110f" strokeWidth="4" paintOrder="stroke" opacity="0.5">?</text>
                </svg>
            </div>
        );
    }
