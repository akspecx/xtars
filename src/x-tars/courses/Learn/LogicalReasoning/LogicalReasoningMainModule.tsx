...
const LEARN_SUB_MODULES = [
   { id: "maths", title: "Linear Arrangement", subtitle: "Let's learn the linear arrangement", icon: "👥👥", gradient: "from-indigo-500 to-purple-500", path: "/learn/logicalReasoning/LinearArrangement"}
