...
const LOGIC_DATA = {
  concept: {
    coreDefinition: {
        title: "Definition: Reflex Angle",
        text: "A reflex angle is the larger, outer angle formed between two intersecting lines or clock hands.\n\n• It is always strictly greater than 180° and less than 360°.\n• To find the reflex angle, simply calculate the smaller interior angle first, then subtract it from 360°."
    },
    question: "The reflex angle between the hands of a clock at exactly 10:25 is:",
    clues: [
      { id: 1, step: 0, concept: "Minute Position", explanation: "At 25 minutes, the minute hand points precisely at the 5.", text: "Identify where the minute hand is located." },
      { id: 2, step: 1, concept: "Base Hour", explanation: "At 10:00, the hour hand starts directly on the 10.", text: "Identify the starting base for the hour hand." },
      { id: 3, step: 2, concept: "Interior Base Gap", explanation: "The shortest path between 5 and 10 is exactly 5 hour-gaps. 5 × 30° = 150°.", text: "Calculate the standard inner angle before the creep." },
      { id: 4, step: 3, concept: "True Interior Angle", explanation: "The hour hand creeps 12.5° (25m × 0.5) AWAY from the 5. So the true interior angle grows: 150° + 12.5° = 162.5°.", text: "Calculate the exact inner angle." },
      { id: 5, step: 4, concept: "Reflex Angle", explanation: "The reflex angle is the larger outer angle. 360° - Interior Angle (162.5°) = 197.5°.", text: "Subtract the interior angle from 360° to find the reflex angle." }
    ],
    teachingSteps: [
      { 
        id: "step-1",
        selectionPrompt: "Step 1: Minute Hand. The time is 10:25. At 25 minutes, which number does the minute hand point to?",
      ...
      { 
        id: "step-2",
        selectionPrompt: "Step 2: Base Hour Hand. Now let's place the hour hand. If it were exactly 10:00 (the start of the hour), where would the hour hand be pointing?",
        options: ["At 10", "At 11", "At 12"],
        correct: 0,
        feedback: [
          "Exactly! At the start of the 10 o'clock hour, the hour hand points straight at the 10.",
          "That would be 11:00.",
          "That is where the minute hand starts the hour."
        ],
        why: "At 10:00, the hour hand is anchored precisely on the 10.",
        instruction: "Click on the number '10' to place the Base Hour Hand.",
        requiredActionState: 'base_hour_placed'
      },
      { 
        id: "step-3",
        selectionPrompt: "Step 3: Base Interior Gap. Look at the shortest path between the 5 and the 10. How many degrees are between them before the hour hand moves? (Hint: 5 gaps)",
        options: ["120°", "150°", "180°"],
        correct: 1,
        feedback: [
          "That would only be 4 gaps.",
          "Correct! There are 5 hour gaps between 5 and 10. 5 gaps × 30° = 150°.",
          "That would be 6 gaps (a straight line)."
        ],
        why: "The shortest base gap between the starting numbers is 150°.",
        instruction: "Logic Confirmed. Proceed to the next step.",
        requiredActionState: 'none' 
      },
      { 
        id: "step-4",
        selectionPrompt: "Step 4: True Interior Angle. The hour hand moves 0.5° per minute. In 25 mins, it creeps 12.5° past the 10 (moving AWAY from the 5). What is the true interior angle?",
        options: ["137.5°", "150°", "162.5°"],
        correct: 2,
        feedback: [
          "You subtracted! But the hand is moving away from the 5, making the gap larger.",
          "That is the angle before the creep.",
          "Correct! Because it moved AWAY from the minute hand, the gap increased: 150° + 12.5° = 162.5°."
        ],
        why: "Base Gap (150°) + Creep Away (12.5°) = True Interior Angle (162.5°).",
        instruction: "Click the 'Add 12.5° Creep' button below the clock to shift the hour hand.",
        requiredActionState: 'hour_creep_added'
      },
      { 
        id: "step-5",
        selectionPrompt: "Step 5: The Reflex Angle. We found the interior angle is 162.5°. But the question asks for the REFLEX (larger outer) angle! Since a full circle is 360°, what is the reflex angle?",
        options: ["162.5°", "197.5°", "200.5°"],
        correct: 1,
        feedback: [
          "That is the interior angle.",
          "Exactly! 360° - 162.5° = 197.5°. The larger outer angle is the reflex angle!",
          "Check your subtraction: 360 - 162.5."
        ],
        why: "Reflex Angle = 360° - Interior Angle (162.5°) = 197.5°.",
        instruction: "Click the 'Draw Reflex Angle' button below the clock to complete the proof!",
        requiredActionState: 'final_angle_drawn'
      }
    ],
    postQuiz: [
      { 
        q: "What defines a Reflex Angle?", 
        options: ["An angle exactly 180°.", "An angle less than 180°.", "An angle strictly greater than 180° and less than 360°."], 
        correct: 2, 
        explanation: "Reflex angles are the large 'outer' portions of the clock, always greater than 180°."
      },
      { 
        q: "If an interior angle is calculated to be 90°, what is the reflex angle?", 
        options: ["180°", "270°", "360°"], 
        correct: 1, 
        explanation: "360° - 90° = 270°."
      }
    ]
  },
  practice: {
    coreDefinition: {
        title: "Concept: Reflex Angle",
        text: "A reflex angle is the larger, outer angle formed between two intersecting lines or clock hands.\n\n• It is always strictly greater than 180° and less than 360°.\n• To find the reflex angle, calculate the smaller interior angle first, then subtract it from 360°."
    },
    practiceQuestions: [
      { 
        timeStr: "8:20", hour: 8, minute: 20,
        q: "What is the exact REFLEX angle between the hands at 8:20?",
        options: ["130°", "230°", "240°"], correct: 1, correctText: "230°",
        explanation: "Interior Angle: Base gap (8 to 4) is 120°. Hour hand creeps 10° AWAY from the 4. Interior = 130°. Reflex = 360° - 130° = 230°."
      },
      { 
        timeStr: "10:15", hour: 10, minute: 15,
        q: "What is the exact REFLEX angle between the hands at 10:15?",
        options: ["142.5°", "217.5°", "225.5°"], correct: 1, correctText: "217.5°",
        explanation: "Minute hand at 3. Hour hand at 10. Clockwise gap from 3 to 10 is 210°. Hour hand creeps 7.5° AWAY. 210° + 7.5° = 217.5°. Because this is >180, it IS the reflex angle!"
      },
      { 
        timeStr: "1:30", hour: 1, minute: 30,
        q: "What is the exact REFLEX angle between the hands at 1:30?",
        options: ["135°", "225°", "235°"], correct: 1, correctText: "225°",
        explanation: "Base gap from 1 to 6 is 150°. Hour hand creeps 15° CLOSER to 6. Interior = 150° - 15° = 135°. Reflex = 360° - 135° = 225°."
      },
      { 
        timeStr: "5:40", hour: 5, minute: 40,
        q: "What is the exact REFLEX angle between the hands at 5:40?",
        options: ["70°", "190°", "290°"], correct: 2, correctText: "290°",
        explanation: "Base gap from 5 to 8 is 90°. Hour hand creeps 20° CLOSER to the 8. Interior = 90° - 20° = 70°. Reflex = 360° - 70° = 290°."
      },
      { 
        timeStr: "3:10", hour: 3, minute: 10,
        q: "What is the exact REFLEX angle between the hands at 3:10?",
        options: ["35°", "325°", "335°"], correct: 1, correctText: "325°",
        explanation: "Base gap from 3 to 2 is 30°. Hour hand creeps 5° AWAY from 2. Interior = 30° + 5° = 35°. Reflex = 360° - 35° = 325°."
      }
    ]
  }
};
...
export default function LabContent() {
  ...
  const handleClockNumberClick = (num) => {
      ...
      } else if (expectedAction === 'base_hour_placed' && num === 10) {
          setClockState('base_hour_placed');
          setActionError("");
      } else if (expectedAction === 'base_hour_placed' && num !== 10) {
          setActionError("Incorrect. At 10:00, the hour hand starts at 10.");
      }
  };
  ...
  if (appMode === 'concept') {
      minuteRotation = 150; // At 5 (10:25)
      if (clockState !== 'idle') showMinute = true;
      
      if (['base_hour_placed', 'hour_creep_added', 'final_angle_drawn'].includes(clockState)) {
          hourRotation = 300; // Base at 10
          showHour = true;
      }
      if (['hour_creep_added', 'final_angle_drawn'].includes(clockState)) {
          hourRotation = 312.5; // 300 + 12.5 degree creep
      }
      // Reflex arc from 312.5 clockwise to 150 (which is 150+360=510)
      arcStart = 312.5;
      arcEnd = 510;
      finalAngleText = "197.5°";
      ...
      if (currentQ) {
          ...
          const diff = Math.abs(hourRotation - minuteRotation);
          
          // Always force the reflex (larger) arc > 180 degrees
          if (diff > 180) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#e6dccb] flex flex-col select-none font-sans text-[14px]" ref={containerRef}>
      ...
      <HeaderSection onBack={() => navigate(-1)} title={appMode === 'concept' ? "Reflex Angle Lab" : "Reflex Angle Drills"} appMode={appMode} setAppMode={handleSetMode} onReset={() => handleReset(appMode)} />
            ...
            <div className="w-full flex flex-col items-center gap-3 h-full">
                ...
                <div className="relative bg-[#3e2723] rounded-full border-[8px] border-yellow-500/30 shadow-[inset_0_20px_50px_rgba(0,0,0,0.5),_0_10px_30px_rgba(0,0,0,0.5)] flex flex-col items-center justify-center w-[280px] h-[280px] sm:w-[340px] sm:h-[340px]">
                  ...
                  <svg viewBox="0 0 300 300" className="w-full h-full drop-shadow-2xl">
                      ...
                      {((appMode === 'concept' && clockState === 'final_angle_drawn') || (appMode === 'practice' && quizFeedbackMode && quizSelection === currentQuizSet[quizStep].correct)) && (
                          <text x="230" y="80" fill="#fde047" fontSize="24" fontWeight="black" textAnchor="middle" style={{ filter: "drop-shadow(1px 2px 2px rgba(0,0,0,0.8))" }}>{finalAngleText}</text>
                      )}
                  </svg>
                </div>
                ...
                {!quizMode && !lessonFinished && appMode === 'concept' && isQuizPassed && (
                    <div className="flex gap-3 mt-4 flex-wrap justify-center animate-in fade-in zoom-in duration-300">
                        ...
                        {activeStep === 4 && (
                            <button onClick={() => handleClockButton('final_angle_drawn')} className="px-6 py-2 rounded-full bg-yellow-500 text-black font-black uppercase text-[12px] shadow-lg hover:scale-105 active:scale-95 transition-all">Draw Reflex Angle</button>
                        )}
                    </div>
                )}
            </div>
