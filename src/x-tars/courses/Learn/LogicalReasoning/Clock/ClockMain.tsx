...
const HIERARCHY_DATA = [
  {
    id: "clockIntro",
    title: "Clock",
    subtitle: "Understanding the clock angles",
    icon: "⚖️",
    gradient: "from-indigo-500 to-purple-500",
    path: "/learn/logicalreasoning/clock",
    subModules: [
      { id: 'CLK_1', title: 'Hour hand angles', desc: 'To go through the hour hand angles', icon: '🔢', path: '/learn/logicalReasoning/clock/introduction' },
      { id: 'CLK_2', title: 'Hour hand rotation', desc: 'find the rotation of hour hand', icon: '🔗', path: '/learn/logicalReasoning/clock/hourhandRotation' },
      { id: 'CLK_3', title: 'Hour hand rotation at minutes', desc: 'at minutes find the hour hand rotation', icon: '🔗', path: '/learn/logicalReasoning/clock/hmHandRotation' },
      { id: 'CLK_4', title: 'Angle between hour and minute hands', desc: 'find the angle between hour and minute hands', icon: '🔗', path: '/learn/logicalReasoning/clock/anglebetweenHMHand' },
      { id: 'CLK_5', title: 'What is reflex angle?', desc: 'find the reflex angle', icon: '🔗', path: '/learn/logicalReasoning/clock/reflexAngle' }     
    ]
  },

   {
    id: "clockHMInteraction",
    title: "Hour and Minute hand interactions",
    subtitle: "Understanding the clock angles",
    icon: "⚖️",
    gradient: "from-indigo-500 to-purple-500",
    path: "/learn/logicalreasoning/clock",
    subModules: [
      { id: 'CLK_6', title: 'Hour and Minute hand overlap?', desc: 'How and when the hour and minute hand overlap', icon: '🔗', path: '/learn/logicalReasoning/clock/hmHandOverlap' },
      { id: 'CLK_7', title: 'Hour and Minute hand at 90 degree?', desc: 'How and when the hour and minute hand are at 90 degree', icon: '🔗', path: '/learn/logicalReasoning/clock/hmHandAt90' },
      { id: 'CLK_8', title: 'Hour and Minute hand in straight line?', desc: 'How and when the hour and minute hand are in straight line', icon: '🔗', path: '/learn/logicalReasoning/clock/hmHandStraightLine' },
      { id: 'CLK_9', title: 'Hour and Minute hand overlap again?', desc: 'How and when the hour and minute hand overlap again', icon: '🔗', path: '/learn/logicalReasoning/clock/hmHandOverlapAgain' }     
    ]
  },
    ...
    path: "/learn/logicalreasoning/clock",
    subModules: [
      { id: 'CLK_10', title: 'Hour and Minute hand has some errors?', desc: 'What if there is some error in the hands', icon: '🔗', path: '/learn/logicalReasoning/clock/hmHandError' },
      { id: 'CLK_11', title: 'Hour and Minute hand making certain angles in a day?', desc: 'How many times there will be certain angles in a day', icon: '🔗', path: '/learn/logicalReasoning/clock/hmHandCertainAnglesInDay' },
      { id: 'CLK_12', title: 'Hour and Minute hand difference recovery?', desc: 'Can the hour and minute hand recover the distance', icon: '🔗', path: '/learn/logicalReasoning/clock/hmHandErrorRecovery' },
