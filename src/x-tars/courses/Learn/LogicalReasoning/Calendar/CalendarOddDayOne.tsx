...
const LOGIC_DATA = {
  concept: {
    question: "Today is Monday. After 61 days, what day of the week will it be?",
    teachingSteps: [
      { 
        id: "step-1",
        selectionPrompt: "Step 1: The Cycle. How many days are there in a full week before the names start repeating?",
        options: ["5 Days", "7 Days", "10 Days"],
        correct: 1,
        feedback: [
          "That's just the work week!",
          "Correct! There are 7 days in a week. The day repeats exactly every 7 days.",
          "Too high!"
        ],
        why: "A week is exactly 7 days long. This means every 7th day will be a Monday again.",
        instruction: "Click 'Highlight Week Cycle' below the calendar to visualize the 7-day loop.",
        requiredActionState: 'week_cycle_shown'
      },
      { 
        id: "step-2",
        selectionPrompt: "Step 2: Full Weeks. We need to jump 61 days. To do this quickly, we divide 61 by 7. What is the nearest multiple of 7 that fits inside 61?",
        options: ["49 (7 weeks)", "56 (8 weeks)", "63 (9 weeks)"],
        correct: 1,
        feedback: [
          "You can fit more weeks into 61!",
          "Exactly! 8 full weeks is 56 days. This leaves a small remainder.",
          "63 is bigger than 61, so we've gone too far into the future."
        ],
        why: "8 weeks × 7 days = 56 days. After exactly 56 days, it will be Monday again!",
        instruction: "Click 'Skip 56 Days' below the calendar to magically fast-forward 8 weeks.",
        requiredActionState: 'full_weeks_calculated'
      },
      { 
        id: "step-3",
        selectionPrompt: "Step 3: The Odd Days. After taking out those 56 days, how many extra days are left over from the original 61?",
        options: ["3 Days", "5 Days", "7 Days"],
        correct: 1,
        feedback: [
          "Check your math: 61 - 56.",
          "Correct! 61 - 56 = 5 extra days. We call these 'Odd Days'.",
          "If there were 7 left, that would be another full week!"
        ],
        why: "61 divided by 7 leaves a remainder of 5. These 5 'Odd Days' are the only ones that actually change the day of the week.",
        instruction: "Click 'Extract Odd Days' below the calendar to isolate the remaining 5 days.",
        requiredActionState: 'remainder_found'
      },
      { 
        id: "step-4",
        selectionPrompt: "Step 4: The Final Jump. If today is Monday, what day will it be if you jump exactly 5 days forward?",
        options: ["Friday", "Saturday", "Sunday"],
        correct: 1,
        feedback: [
          "That's 4 days forward (Tue, Wed, Thu, Fri).",
          "Correct! 5 days after Monday is Saturday. (Tue, Wed, Thu, Fri, Sat).",
          "That's 6 days forward."
        ],
        why: "Monday + 5 days = Saturday. You solved it effortlessly using the Odd Days trick!",
        instruction: "Click 'Jump 5 Days' on the visualizer to reveal the final answer.",
        requiredActionState: 'final_day_found'
      }
    ]
  },
  practice: {
    question: "Apply the 'Odd Days' trick to solve these fast!",
    quiz: [
      { 
        q: "Today is Tuesday. After 15 days, it will be:", 
        startDayIdx: 2, 
        endDayIdx: 3,
        options: ["Monday", "Wednesday", "Thursday"], 
        correct: 1, 
        explanation: "15 ÷ 7 = 2 remainder 1. Jump 1 day forward from Tuesday -> Wednesday.",
        breakdown: { division: "15 ÷ 7 = 2 Weeks", remainder: "1 Day", jump: "Tuesday + 1 = Wednesday" }
      },
      { 
        q: "Today is Friday. After 24 days, it will be:", 
        startDayIdx: 5, 
        endDayIdx: 1,
        options: ["Monday", "Sunday", "Tuesday"], 
        correct: 0, 
        explanation: "24 ÷ 7 = 3 remainder 3. Jump 3 days forward from Friday (Sat, Sun, Mon) -> Monday.",
        breakdown: { division: "24 ÷ 7 = 3 Weeks", remainder: "3 Days", jump: "Friday + 3 = Monday" }
      },
      { 
        q: "Today is Sunday. After 50 days, it will be:", 
        startDayIdx: 0, 
        endDayIdx: 1,
        options: ["Saturday", "Monday", "Tuesday"], 
        correct: 1, 
        explanation: "50 ÷ 7 = 7 remainder 1. Jump 1 day forward from Sunday -> Monday.",
        breakdown: { division: "50 ÷ 7 = 7 Weeks", remainder: "1 Day", jump: "Sunday + 1 = Monday" }
      },
      { 
        q: "Today is Wednesday. After 77 days, it will be:", 
        startDayIdx: 3, 
        endDayIdx: 3,
        options: ["Wednesday", "Thursday", "Friday"], 
        correct: 0, 
        explanation: "77 ÷ 7 = 11 remainder 0. Jump 0 days! It remains Wednesday.",
        breakdown: { division: "77 ÷ 7 = 11 Weeks", remainder: "0 Days", jump: "Wednesday + 0 = Wednesday" }
      },
      { 
        q: "Today is Thursday. After 100 days, it will be:", 
        startDayIdx: 4, 
        endDayIdx: 6,
        options: ["Friday", "Saturday", "Sunday"], 
        correct: 1, 
        explanation: "100 ÷ 7 = 14 remainder 2. Jump 2 days forward from Thursday (Fri, Sat) -> Saturday.",
        breakdown: { division: "100 ÷ 7 = 14 Weeks", remainder: "2 Days", jump: "Thursday + 2 = Saturday" }
      }
    ]
  }
};
...
export function LabContent() {
  ...
  // Visualizer State
  const [calendarState, setCalendarState] = useState('idle'); // idle -> week_cycle_shown -> full_weeks_calculated -> remainder_found -> final_day_found
  ...
  function prevStep() {
      if (activeStep > 0) {
          ...
          if (prevIdx === 1) setCalendarState('week_cycle_shown');
          if (prevIdx === 2) setCalendarState('full_weeks_calculated');
          if (prevIdx === 3) setCalendarState('remainder_found');
      }
  }
  ...
  const isBoardValid = appMode === 'concept' && calendarState === LOGIC_DATA.concept.teachingSteps[activeStep]?.requiredActionState;
  ...
  const renderWeekCircle = () => {
    return daysOfWeek.map((day, i) => {
        ...
        if (appMode === 'concept') {
            isStart = (i === 1 && calendarState !== 'idle');
            isEnd = (i === 6 && calendarState === 'final_day_found'); 
  ...
  const getArcAngles = () => {
      if (appMode === 'concept') {
          if (calendarState === 'remainder_found' || calendarState === 'final_day_found') {
              return { start: 1 * (360/7), end: 6 * (360/7) };
          }
      } else if (appMode === 'practice' && quizFeedbackMode) {
          const currentQ = LOGIC_DATA.practice.quiz[quizStep];
          return { start: currentQ.startDayIdx * (360/7), end: currentQ.endDayIdx * (360/7) };
      }
      return null;
  }
  ...
  return (
    <div className="h-[100dvh] w-full flex flex-col bg-[#e6dccb] font-sans select-none overflow-hidden text-[#5d4037] relative" ref={containerRef}>
      ...
      {/* HEADER */}
      <HeaderSection onBack={() => navigate(-1)} title={appMode === 'concept' ? "Calendar Logic Lab" : "Odd Days Calculator"} appMode={appMode} setAppMode={handleSetMode} onReset={() => handleReset(appMode)} />
            ...
            <div className="w-full h-full flex flex-col items-center justify-center pt-4 pb-2 px-2 overflow-y-auto no-scrollbar relative z-10">
                ...
                <div className="relative bg-[#3e2723] rounded-full border-[8px] border-yellow-500/30 shadow-[inset_0_20px_50px_rgba(0,0,0,0.5),_0_10px_30px_rgba(0,0,0,0.5)] flex flex-col items-center justify-center w-[220px] h-[220px] sm:w-[280px] sm:h-[280px] lg:w-[320px] lg:h-[320px]">
                  ...
                  <svg viewBox="0 0 300 300" className="w-full h-full drop-shadow-2xl">
                      ...
                      {/* Dynamic Central Text based on State */}
                      {appMode === 'concept' && calendarState === 'full_weeks_calculated' && (
                          <text x="150" y="150" fill="#facc15" fontSize="16" fontWeight="bold" textAnchor="middle" dominantBaseline="central">
                              <tspan x="150" dy="-10">56 Days = 8 Weeks</tspan>
                              <tspan x="150" dy="20">Back to Monday!</tspan>
                          </text>
                      )}

                      {appMode === 'concept' && calendarState === 'remainder_found' && (
                          <text x="150" y="150" fill="#38bdf8" fontSize="20" fontWeight="bold" textAnchor="middle" dominantBaseline="central">+ 5 Odd Days</text>
                      )}

                      {appMode === 'concept' && calendarState === 'final_day_found' && (
                          <text x="150" y="150" fill="#22c55e" fontSize="16" fontWeight="bold" textAnchor="middle" dominantBaseline="central">
                              <tspan x="150" dy="-10">MON + 5 Days</tspan>
                              <tspan x="150" dy="24" fontSize="20">= SATURDAY</tspan>
                          </text>
                      )}

                      {appMode === 'practice' && quizFeedbackMode && quizSelection === currentQuizSet[quizStep].correct && (
                          <text x="150" y="150" fill="#22c55e" fontSize="18" fontWeight="bold" textAnchor="middle" dominantBaseline="central">Target Found!</text>
                      )}
                ...
                {/* Contextual Action Buttons for Concept Steps (Only show after quiz passed) */}
                {appMode === 'concept' && (
                    <div className="flex flex-wrap justify-center gap-2 mt-4 min-h-[40px]">
                        <AnimatePresence mode="wait">
                            {isQuizPassed && !isBoardValid && (
                                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.9 }}>
                                    {activeStep === 0 && (
                                        <button onClick={() => handleCalendarButton('week_cycle_shown')} className="px-5 py-2.5 rounded-full bg-indigo-600 text-white font-black uppercase text-[10px] sm:text-[12px] shadow-[0_0_15px_rgba(79,70,229,0.5)] hover:scale-105 active:scale-95 transition-all">Highlight Week Cycle</button>
                                    )}
                                    {activeStep === 1 && (
                                        <button onClick={() => handleCalendarButton('full_weeks_calculated')} className="px-5 py-2.5 rounded-full bg-indigo-600 text-white font-black uppercase text-[10px] sm:text-[12px] shadow-[0_0_15px_rgba(79,70,229,0.5)] hover:scale-105 active:scale-95 transition-all">Skip 56 Days (8 Weeks)</button>
                                    )}
                                    {activeStep === 2 && (
                                        <button onClick={() => handleCalendarButton('remainder_found')} className="px-5 py-2.5 rounded-full bg-blue-500 text-white font-black uppercase text-[10px] sm:text-[12px] shadow-[0_0_15px_rgba(59,130,246,0.5)] hover:scale-105 active:scale-95 transition-all">Extract Odd Days</button>
                                    )}
                                    {activeStep === 3 && (
                                        <button onClick={() => handleCalendarButton('final_day_found')} className="px-5 py-2.5 rounded-full bg-green-500 text-white font-black uppercase text-[10px] sm:text-[12px] shadow-[0_0_15px_rgba(34,197,94,0.5)] hover:scale-105 active:scale-95 transition-all">Jump 5 Days</button>
                                    )}
                                </motion.div>
                            )}
                        </AnimatePresence>
        ...
        <div className="flex-[0.8] lg:flex-[1.0] w-full bg-[#3e2723] p-3 sm:p-5 rounded-[1.5rem] sm:rounded-[2rem] border-t-4 border-black shadow-2xl relative z-20 flex flex-col gap-2 overflow-hidden min-h-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1.8fr] gap-3 sm:gap-6 h-full relative z-10">
            ...
            <div className="flex flex-col gap-3 h-full min-h-0">
                ...
                {appMode === 'concept' && (
                    <div className="flex-1 flex flex-col bg-[#2a1a16]/95 rounded-2xl border-2 border-black/50 shadow-lg overflow-y-auto custom-scrollbar p-3">
                        <div className="flex items-center gap-2 opacity-50 mb-2 border-b border-white/10 pb-2">
                            ...
                            <span className="text-[#a88a6d] font-black uppercase text-[10px] sm:text-[11px] tracking-wider">Concept Steps</span>
                        </div>
                        <div className="flex flex-col gap-3">
                            {LOGIC_DATA.concept.teachingSteps.map((clue, idx) => {
                                ...
                                return (
                                  <div key={clue.id} className={`flex flex-col gap-1 ${isActive ? 'opacity-100' : 'opacity-50'}`}>
                                    ...
                                    <p className="text-white text-[12px] leading-snug pl-2 border-l-2 border-white/20 mt-1">{clue.why}</p>
                                  </div>
                                );
                            })}
                        </div>
                ...
                {/* Detailed Practice Breakdown (Only in Practice Mode after answer) */}
                {appMode === 'practice' && (
                    <div className="flex-1 flex flex-col bg-[#2a1a16]/95 rounded-2xl border-2 border-black/50 shadow-lg overflow-y-auto custom-scrollbar p-3">
                        {quizFeedbackMode && quizSelection === currentQuizSet[quizStep].correct ? (
                            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="flex flex-col h-full">
                                <h4 className="text-emerald-400 font-black uppercase text-[10px] sm:text-[12px] tracking-widest mb-3 flex items-center gap-1.5 border-b border-emerald-500/20 pb-2">
                                    <CheckCircle2 size={16}/> Detailed Breakdown
                                </h4>
                            ...
                            <div className="flex flex-col items-center justify-center h-full opacity-30 text-center px-4">
                                ...
                                <p className="text-[11px] font-bold uppercase tracking-widest">Detailed breakdown will appear here after a correct answer.</p>
                            </div>
                        )}
                    </div>
                )}
                                ...
                                {quizFeedbackMode && (
                                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col gap-3 mt-auto pt-2">
                                        <div className="flex gap-2 w-full mt-2">
                                            ...
                                            {!quizFeedbackMode || quizSelection !== currentQuizSet[quizStep].correct ? (
                                                <button onClick={() => setQuizFeedbackMode(false)} className="flex-1 py-3 bg-rose-600 text-white rounded-xl font-black text-[11px] uppercase border-b-4 border-rose-800 active:translate-y-1 active:border-b-0 transition-all">Try Again</button>
                                            ) : null}
               ...
               >
                  ...
                  <div className="flex flex-col gap-2 relative z-10">
                      ...
                      <p className="text-[#e6dccb] text-sm sm:text-base font-medium px-4 mt-2">
                          {appMode === 'concept' 
                              ? "You've successfully mapped the 'Odd Days' trick using remainders." 
