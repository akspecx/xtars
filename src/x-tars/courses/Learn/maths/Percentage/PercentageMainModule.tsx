...
const HIERARCHY_DATA = [
  {
    ...
    subtitle: "Understanding the percentage?",
    icon: "%",
    gradient: "from-indigo-500 to-purple-500",
    path: "/learn/mathematics/percentage",
    subModules: [
      { id: 'Perc_1', title: 'Introduction', desc: 'To go through the introduction', icon: '🔢', path: '/learn/mathematics/percentage/introduction' },
      { id: 'Perc_2', title: 'Calculation', desc: 'To understand the calculation', icon: '�', path: '/learn/mathematics/percentage/calculation' },
      { id: 'Perc_3', title: 'Percentage of common fractions', desc: 'To understand the percentage of common fractions', icon: '%', path: '/learn/mathematics/percentage/fractionPerc' },
      { id: 'Perc_4', title: 'Setting up the Formula', desc: 'How to find the percentage', icon: ' %', path: '/learn/mathematics/percentage/FindPerc' },
      { id: 'Perc_5', title: 'Percentage Calculation Game', desc: 'Let us play a game', icon: '🔢', path: '/learn/mathematics/percentage/PercGame' }      
    ...
    {
    id: "clockIntro",
    title: "Find the Value if Percentage is given",
    subtitle: "Understanding the meaning of % and how to find the value if percentage is given",
    icon: "%",
    gradient: "from-indigo-500 to-purple-500",
    path: "/learn/mathematics/percentage",
    subModules: [
      { id: 'Perc_6', title: 'What is the value if percentage is given', desc: 'Finding Percentage from total', icon: '%', path: '/learn/mathematics/percentage/PercFromTotal' },
      { id: 'Perc_7', title: 'Percentage Meaning', desc: 'What is the meaning of 20%', icon: ' %', path: '/learn/mathematics/percentage/PercKnownGeneric' },
      { id: 'Perc_8', title: 'Building Percentage General Formula', desc: 'What is the golden formula', icon: '🧮', path: '/learn/mathematics/percentage/PercValueGodlenFormula' }
    ...
    {
    id: "clockIntro",
    title: "Value if increased or decreased by percentage",
    subtitle: "Understanding the value if it is increased or decreased by percentage",
    icon: "%",
    gradient: "from-indigo-500 to-purple-500",
    path: "/learn/mathematics/percentage",
    subModules: [
      { id: 'Perc_9', title: 'Value increased by', desc: 'How to calculate new value if it is increased by', icon: '%', path: '/learn/mathematics/percentage/PercIncreasedBy' },
      { id: 'Perc_10', title: 'Value decreased by', desc: 'How to calculate new value if it is decreased by', icon: '%', path: '/learn/mathematics/percentage/PercDecreasedBy' },
      { id: 'Perc_11', title: 'Value increased and decreased', desc: 'How to calculate new value if it is increased and decreased', icon: '%', path: '/learn/mathematics/percentage/PercIncreasedDecreased' }
