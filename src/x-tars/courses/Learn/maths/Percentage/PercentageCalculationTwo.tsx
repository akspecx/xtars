...
const LOGIC_DATA = {
  concept: {
    question: "How do we find percentages when we don't have 100 slices?",
    teachingSteps: [
      { 
        id: "step-1",
        type: "mcq",
        ...
        totalUnits: 4,
        showPct: 1, 
        selectionPrompt: "Step 1: The Whole = 100%. The 'Whole Thing' is always equal to exactly 100%. This pizza is cut into 4 slices. If all 4 slices together make 100%, how do we find the percentage of just 1 slice?",
        options: ["Divide 100 by 4", "Multiply 100 by 4", "Add 4 to 100"],
        correct: 0,
        feedback: [
          "Exactly! We divide the 100% by the number of slices.",
          "That would be 400%!",
          "That would be 104%."
        ],
        why: "To find the percentage of 1 part, you divide 100% by the total number of parts."
      },
      { 
        id: "step-2",
        type: "interactive",
        ...
        totalUnits: 4,
        targetClicks: 1,
        selectionPrompt: "Step 2: 1 Slice = 25%. 100 divided by 4 is exactly 25. This means each individual slice contributes exactly 25%! Tap exactly 1 slice in the visualizer to claim your 25% share.",
        why: "1 slice out of 4 is exactly 25% of the pizza."
      },
      { 
        id: "step-3",
        type: "mcq",
        ...
        totalUnits: 4,
        showPct: 1,
        selectionPrompt: "Step 3: Different Items, Same Math. Let's look at a phone battery with 4 cells. The full battery is 100%. Just like the pizza, how much percentage does 1 cell hold?",
        options: ["10%", "25%", "50%"],
        correct: 1,
        feedback: [
          "10% * 4 is only 40%.",
          "Spot on! 100 / 4 = 25%.",
          "That would only be 2 cells!"
        ],
        why: "100% divided by 4 cells equals exactly 25% per cell."
      },
      { 
        id: "step-4",
        type: "mcq",
        ...
        totalUnits: 4,
        showPct: 0.75,
        selectionPrompt: "Step 4: Building Percentages. If 1 cell is exactly 25%, what percentage do you have if 3 cells are filled? (25% + 25% + 25%)",
        options: ["50%", "75%", "100%"],
        correct: 1,
        feedback: [
          "That's only 2 cells.",
          "Exactly! 3 times 25 is 75.",
          "That would be all 4 cells."
        ],
        why: "3 cells holding 25% each equals exactly 75%."
      },
      { 
        id: "step-5",
        type: "interactive",
        ...
        totalUnits: 4,
        targetClicks: 3,
        selectionPrompt: "Step 5: Show 75%! Now it's your turn. Tap the battery cells to charge it up to exactly 75%!",
        why: "3 out of 4 cells equals exactly 75%."
      }
    ],
    clues: [
      { id: 1, step: 0, concept: "The Whole", explanation: "The 'Whole Thing' is always 100%, no matter how many pieces it is cut into.", text: "Whole = 100%." },
      { id: 2, step: 1, concept: "Finding 1 Part", explanation: "Divide 100 by the total number of parts to find what 1 part is worth.", text: "100 / Total Parts." },
      { id: 3, step: 2, concept: "Quarters", explanation: "If something has 4 parts, each part is 25% because 100/4 = 25.", text: "1 out of 4 = 25%." },
      { id: 4, step: 3, concept: "Adding Up", explanation: "Once you know what 1 part is worth, you can add them together (e.g., 25 + 25 + 25 = 75%).", text: "Add the percentages." }
    ]
  },
  practice: {
    question: "Solve these visual percentage puzzles!",
    quiz: [
      { 
        type: "interactive",
        q: "Your phone battery has 4 energy bars. Tap the bars to show that it is exactly 50% charged!", 
        theme: 'battery', totalUnits: 4, targetClicks: 2,
        explanation: "1 bar is 25%. So 2 bars equals 50% (25 + 25).",
        breakdown: { logic: "100 / 4 = 25% per bar", calculation: "50% / 25%", jump: "2 Bars" }
      },
      { 
        type: "interactive",
        q: "This pizza has 4 slices. You want to eat exactly 75% of it. Tap the slices you will eat!", 
        theme: 'pizza', totalUnits: 4, targetClicks: 3,
        explanation: "1 slice is 25%. To get 75%, you need 3 slices (25 + 25 + 25).",
        breakdown: { logic: "100 / 4 = 25% per slice", calculation: "75% / 25%", jump: "3 Slices" }
      },
      { 
        type: "mcq",
        q: "This chocolate bar has 10 pieces. The whole bar is 100%. What is the percentage of just 1 piece?", 
        theme: 'chocolate', totalUnits: 10, showPct: 1,
        options: ["10%", "5%", "1%"], 
        correct: 0, 
        explanation: "100% divided by 10 pieces equals exactly 10% per piece.",
        breakdown: { logic: "Whole = 100%", calculation: "100 / 10 Pieces", jump: "10% per piece" }
      },
      { 
        type: "interactive",
        q: "Since 1 chocolate piece is 10%, tap the chocolate to eat exactly 40% of the bar!", 
        theme: 'chocolate', totalUnits: 10, targetClicks: 4,
        explanation: "If 1 piece is 10%, then 4 pieces give you 40% (10 + 10 + 10 + 10).",
        breakdown: { logic: "1 Piece = 10%", calculation: "40% / 10%", jump: "4 Pieces" }
      },
      { 
        type: "mcq",
        q: "A new battery has 5 cells total. The full battery is 100%. What is the percentage of just 1 cell?", 
        theme: 'battery', totalUnits: 5, showPct: 1,
        options: ["20%", "25%", "50%"], 
        correct: 0, 
        explanation: "100% divided by 5 cells equals exactly 20% per cell.",
        breakdown: { logic: "Whole = 100%", calculation: "100 / 5 Cells", jump: "20% per cell" }
      },
      { 
        type: "interactive",
        q: "This battery has 5 cells (each is worth 20%). Tap the cells to charge it to exactly 80%!", 
        theme: 'battery', totalUnits: 5, targetClicks: 4,
        explanation: "If 1 cell is 20%, you need 4 cells to reach 80% (20 + 20 + 20 + 20 = 80).",
        breakdown: { logic: "1 Cell = 20%", calculation: "80% / 20%", jump: "4 Cells" }
      }
    ]
  }
};
