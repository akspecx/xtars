...
const translations = {
  en: {
    ...
    equationSteps: [
      {
        step: 1,
        equation: "3X + 1 = 7",
        explanation: "The equation '3 * weight of one apple + 1 = 7' shows our balanced scale in math form. We use X to represent the unknown weight of each apple, so we can write it as 3X + 1 = 7.",
        voice: "The equation 3 times weight of one apple, plus 1, equals 7. We use X to represent the unknown weight of each apple, so we can write it as 3X plus 1 equals 7."
      },
      {
        step: 2,
        equation: "3X + 1 - 1 = 7 - 1",
        explanation: "Our goal is to get the apples by themselves on one side. To do this, we need to remove the '1 gm' weight. We do this by subtracting 1 from both sides of the equation. This is a crucial step because whatever we do to one side, we must do to the other to keep the equation balanced.",
        voice: "Our goal is to get the apples by themselves on one side. To do this, we need to remove the '1 gm' weight. We do this by subtracting 1 from both sides of the equation. This is a crucial step because whatever we do to one side, we must do to the other to keep the equation balanced."
      },
      {
        step: 3,
        equation: "3X = 6",
        explanation: "After subtracting 1 from both sides, the equation becomes 3X = 6. We now have 3 apples on the left, and a total weight of 6 grams on the right.",
        voice: "After subtracting 1 from both sides, the equation becomes 3X = 6. We now have 3 apples on the left, and a total weight of 6 grams on the right."
      },
      {
        step: 4,
        equation: "3X / 3 = 6 / 3",
        explanation: "Now we have 3 apples that equal 6 grams. To find the weight of a single apple, we need to get rid of the '3' (the coefficient). We do this by dividing both sides by the number of apples, which is 3. This makes the coefficient of X equal to 1.",
        voice: "Now we have 3 apples that equal 6 grams. To find the weight of a single apple, we need to get rid of the '3' (the coefficient). We do this by dividing both sides by the number of apples, which is 3. This makes the coefficient of X equal to 1.",
      },
      {
        step: 5,
        equation: "X = 2",
        explanation: "By dividing both sides by 3, we get our final answer: X = 2. This means each apple weighs 2 grams!",
        voice: "By dividing both sides by 3, we get X equals 2. This means each apple weighs 2 grams!"
      }
    ],
    continue: "Continue",
    solve: "Solve",
    ...
    substitute: "Substitute X = 2:",
    calculate: "Calculate:",
    perfect: "✅ Perfect! Each apple weighs exactly 2 grams!",
    finalVerification: {
      text: "Now let's verify our answer. Since we found that each apple weighs 2 grams, the left side of the scale is 3 times 2 plus 1, which equals 7. This is the same as the right side, so the scale remains balanced!",
      voice: "Now let's verify our answer. The left side is 3 times 2 plus 1, which equals 7. This is the same as the right side, so the scale is balanced.",
    }
  },
  hi: {
    ...
    equationSteps: [
      {
        step: 1,
        equation: "3X + 1 = 7",
        explanation: "समीकरण '3 * एक सेब का वजन + 1 = 7' गणितीय रूप में हमारे संतुलित पैमाने को दर्शाता है। हम प्रत्येक सेब के अज्ञात वजन को दर्शाने के लिए X का उपयोग करते हैं, इसलिए हम इसे 3X + 1 = 7 के रूप में लिख सकते हैं।",
        voice: "समीकरण '3 * एक सेब का वजन + 1 = 7' गणितीय रूप में हमारे संतुलित पैमाने को दर्शाता है। हम प्रत्येक सेब के अज्ञात वजन को दर्शाने के लिए X का उपयोग करते हैं, इसलिए हम इसे 3X + 1 = 7 के रूप में लिख सकते हैं।"
      },
      {
        step: 2,
        equation: "3X + 1 - 1 = 7 - 1",
        explanation: "हमारा लक्ष्य एक तरफ सेब को अकेले रखना है। ऐसा करने के लिए, हमें 1 ग्राम वजन को हटाना होगा। हम समीकरण के दोनों पक्षों से 1 घटाकर ऐसा करते हैं। जैसा कि हमने सीखा, समीकरण को संतुलित रखने के लिए हम एक तरफ जो कुछ भी करते हैं, उसे दूसरी तरफ भी करना चाहिए।",
        voice: "हमारा लक्ष्य सेब को अकेले रखना है। हम समीकरण को संतुलित रखने के लिए दोनों पक्षों से 1 घटाते हैं।"
      },
      {
        step: 3,
        equation: "3X = 6",
        explanation: "दोनों पक्षों से 1 घटाने के बाद, समीकरण 3X = 6 हो जाता है। अब हमारे पास बाईं ओर 3 सेब और दाईं ओर कुल 6 ग्राम वजन है।",
        voice: "दोनों पक्षों से 1 घटाने के बाद, समीकरण 3X बराबर 6 हो जाता है। यह सरल है।"
      },
      {
        step: 4,
        equation: "3X / 3 = 6 / 3",
        explanation: "अब हमारे पास 3 सेब हैं जिनका वजन 6 ग्राम है। एक सेब का वजन पता लगाने के लिए, हमें दोनों पक्षों को सेब की संख्या, जो कि 3 है, से भाग देना होगा। इससे X का गुणांक 1 हो जाएगा।",
        voice: "अब हमारे पास 3 सेब हैं जिनका वजन 6 ग्राम है। एक सेब का वजन पता लगाने के लिए, हम दोनों पक्षों को 3 से भाग देते हैं।"
      },
      {
        step: 5,
        equation: "X = 2",
        explanation: "हमें X = 2 मिला, इसलिए प्रत्येक सेब का वजन 2 ग्राम है। अब हम अपने समाधान को सत्यापित कर सकते हैं।",
        voice: "हमें X = 2 मिला, इसलिए प्रत्येक सेब का वजन 2 ग्राम है। अब हम अपने समाधान को सत्यापित कर सकते हैं।"
      }
    ],
    continue: "जारी रखें",
    solve: "हल करें",
    ...
    substitute: "X = 2 रखें:",
    calculate: "गणना करें:",
    perfect: "✅ बिलकुल सही! प्रत्येक सेब का वजन ठीक 2 ग्राम है!",
    finalVerification: {
      text: "अब आइए अपने उत्तर को सत्यापित करें। चूंकि हमें पता चला कि प्रत्येक सेब का वजन 2 ग्राम है, तो पैमाने का बायां पक्ष 3 गुना 2 प्लस 1 है, जो 7 के बराबर है। यह दाईं ओर के वजन के समान है, इसलिए पैमाना संतुलित रहता है!",
      voice: "अब आइए अपने उत्तर को सत्यापित करें। बायां पक्ष 3 गुना 2 प्लस 1 है, जो 7 के बराबर है। यह दाईं ओर के वजन के समान है, इसलिए पैमाना संतुलित है।",
    }
  },
};
...
const App = () => {
  ...
  const [rightPanWeight, setRightPanWeight] = useState(7);
      ...
      case 2:
        return (
          <p className="font-mono text-gray-800 dark:text-gray-200">
            3X <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">+ 1</span> - 1 = 7 - 1
          </p>
        );
      case 4:
        return (
          <p className="font-mono text-gray-800 dark:text-gray-200">
            <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">3</span>X / <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">3</span> = 6 / <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">3</span>
          </p>
        );
      default:
  ...
  const renderVerification = () => {
    return (
      <div className={`mt-6 p-4 rounded-lg shadow-inner ${theme === 'light' ? 'bg-indigo-50 text-indigo-800' : 'bg-gray-800 text-gray-200'}`}>
        ...
        <p className="font-mono">{t('originalEquation')} <span className="text-yellow-400 font-bold">3X + 1 = 7</span></p>
        <p className="font-mono">{t('substitute')} <span className="text-yellow-400 font-bold">3(2) + 1 = ?</span></p>
        <p className="font-mono">{t('calculate')} <span className="text-yellow-400 font-bold">6 + 1 = 7</span> ✅</p>
