...
const translations = {
  en: {
    ...
    correctAnswer: "🎉 Correct! The answer is 8!",
    incorrectAnswer: "❌ Incorrect. Please try again.",

    // Solving Equations Module
    solveEquationIntro: {
      text: "3(X - 2) = X + 10. Can you find the value of X?",
      voice: "3 times the quantity of X minus 2 equals X plus 10. Can you find the value of X?",
    },
    equationSteps: [
      {
        step: 1,
        equation: "3(X - 2) = X + 10",
        explanation: "The equation '3(X - 2) = X + 10' is what we need to solve. Our goal is to find the value of X.",
        voice: "The equation 3 times the quantity of X minus 2 equals X plus 10 is what we need to solve. Our goal is to find the value of X."
      },
      {
        step: 2,
        equation: "3X - 6 = X + 10",
        explanation: "First, we apply the distributive property on the left side by multiplying 3 with each term inside the parentheses. This simplifies the equation to 3X - 6 = X + 10.",
        voice: "First, we apply the distributive property on the left side. This simplifies the equation to 3X minus 6 equals X plus 10."
      },
      {
        step: 3,
        equation: "3X - X - 6 = X - X + 10",
      ...
      },
      {
        step: 4,
        equation: "2X - 6 = 10",
        explanation: "After subtracting X from both sides, the equation simplifies to 2X - 6 = 10. Now, we have all the X terms on one side.",
        voice: "After subtracting X from both sides, the equation simplifies to 2X minus 6 equals 10."
      },
      {
        step: 5,
        equation: "2X - 6 + 6 = 10 + 6",
        explanation: "To get the X term by itself, we need to remove the '-6' from the left side. We do this by adding 6 to both sides of the equation.",
        voice: "To get the X term by itself, we add 6 to both sides of the equation."
      },
      {
        step: 6,
        equation: "2X = 16",
        explanation: "After adding 6 to both sides, the equation simplifies to 2X = 16.",
        voice: "After adding 6 to both sides, the equation simplifies to 2X equals 16."
      },
      {
        step: 7,
        equation: "2X / 2 = 16 / 2",
        explanation: "Now, to find the value of a single 'X', we need to remove the coefficient '2'. We do this by dividing both sides by 2.",
        voice: "Now, to find the value of a single X, we divide both sides by 2."
      },
      {
        step: 8,
        equation: "X = 8",
        explanation: "By dividing both sides by 2, we get our final answer: X = 8.",
        voice: "By dividing both sides by 2, we get X equals 8."
      },
      {
        step: 9,
        equation: "Final Verification",
        explanation: "Now let's verify our answer. Substitute X = 8 back into the original equation: 3(8 - 2) = 8 + 10, which simplifies to 3(6) = 18. Both sides equal 18. This is correct!",
        voice: "Now let's verify our answer. The left side is 3 times the quantity of 8 minus 2, which equals 18. The right side is 8 plus 10, which also equals 18. The equation is balanced!"
      }
    ],
    continue: "Continue",
    solve: "Solve",
  ...
  hi: {
    ...
    correctAnswer: "🎉 सही! उत्तर 8 है!",
    incorrectAnswer: "❌ गलत। कृपया पुनः प्रयास करें।",

    // Solving Equations Module
    solveEquationIntro: {
      text: "3(X - 2) = X + 10. क्या आप X का मान ज्ञात कर सकते हैं?",
      voice: "3 गुणा (X माइनस 2) बराबर X प्लस 10। क्या आप X का मान ज्ञात कर सकते हैं?"
    },
    equationSteps: [
      {
        step: 1,
        equation: "3(X - 2) = X + 10",
        explanation: "समीकरण '3(X - 2) = X + 10' हमें हल करने के लिए दिया गया है। हमारा लक्ष्य X का मान ज्ञात करना है।",
        voice: "समीकरण 3 गुणा (X माइनस 2) बराबर X प्लस 10 है। हमारा लक्ष्य X का मान ज्ञात करना है।"
      },
      {
        step: 2,
        equation: "3X - 6 = X + 10",
        explanation: "पहले, हम बाईं ओर प्रत्येक पद को 3 से गुणा करके वितरणात्मक गुण लागू करते हैं। इससे समीकरण 3X - 6 = X + 10 हो जाता है।",
        voice: "पहले, हम बाईं ओर वितरणात्मक गुण लागू करते हैं। इससे समीकरण 3X माइनस 6 बराबर X प्लस 10 हो जाता है।"
      },
      {
        step: 3,
        equation: "3X - X - 6 = X - X + 10",
      ...
      },
      {
        step: 4,
        equation: "2X - 6 = 10",
        explanation: "दोनों पक्षों से X घटाने के बाद, समीकरण 2X - 6 = 10 हो जाता है। अब, हमारे पास सभी X पद एक तरफ हैं।",
        voice: "दोनों पक्षों से X घटाने के बाद, समीकरण 2X माइनस 6 बराबर 10 हो जाता है।"
      },
      {
        step: 5,
        equation: "2X - 6 + 6 = 10 + 6",
        explanation: "X पद को अकेले प्राप्त करने के लिए, हमें बाईं ओर से '-6' को हटाना होगा। हम समीकरण के दोनों पक्षों में 6 जोड़कर ऐसा करते हैं।",
        voice: "X पद को अकेले प्राप्त करने के लिए, हम दोनों पक्षों में 6 जोड़ते हैं।"
      },
      {
        step: 6,
        equation: "2X = 16",
        explanation: "दोनों पक्षों में 6 जोड़ने के बाद, समीकरण 2X = 16 हो जाता है।",
        voice: "दोनों पक्षों में 6 जोड़ने के बाद, समीकरण 2X बराबर 16 हो जाता है।"
      },
      {
        step: 7,
        equation: "2X / 2 = 16 / 2",
        explanation: "अब, एक 'X' का मान ज्ञात करने के लिए, हमें गुणांक '2' को हटाना होगा। हम समीकरण के दोनों पक्षों को 2 से भाग देकर ऐसा करते हैं।",
        voice: "अब, एक X का मान ज्ञात करने के लिए, हम दोनों पक्षों को 2 से भाग देते हैं।"
      },
      {
        step: 8,
        equation: "X = 8",
        explanation: "दोनों पक्षों को 2 से भाग देने पर, हमें हमारा अंतिम उत्तर मिलता है: X = 8।",
        voice: "दोनों पक्षों को 2 से भाग देने पर, हमें X बराबर 8 मिलता है।"
      },
      {
        step: 9,
        equation: "Final Verification",
        explanation: "अब आइए अपने उत्तर की जाँच करें। X = 8 को मूल समीकरण में रखें: 3(8 - 2) = 8 + 10, जो 3(6) = 18 हो जाता है। दोनों पक्ष 18 के बराबर हैं। यह सही है!",
        voice: "अब आइए अपने उत्तर की जाँच करें। बायां पक्ष 3 गुणा (8 माइनस 2) है, जो 18 के बराबर है। दायां पक्ष 8 प्लस 10 है, जो भी 18 के बराबर है। समीकरण संतुलित है।"
      }
    ],
    continue: "जारी रखें",
    solve: "हल करें",
      ...
      case 2:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">3X - 6</span> = X + 10
          </p>
        );
      case 3:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            3X <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">- X</span> - 6 = X <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">- X</span> + 10
          </p>
        );
      case 4:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">2X - 6</span> = <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">10</span>
          </p>
        );
      case 5:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            2X - 6 <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">+ 6</span> = 10 <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">+ 6</span>
          </p>
        );
      case 6:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">2X</span> = <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">16</span>
          </p>
        );
      case 7:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">2</span>X / <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">2</span> = 16 / <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">2</span>
          </p>
        );
      case 8:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            X = <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">8</span>
          </p>
        );
      case 9:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            {t('originalEquation')} <span className="text-grey-800 font-bold">3(X - 2) = X + 10</span><br />
            {t('substitute')} <span className="text-grey-800 font-bold">3({`8`} - 2) = 8 + 10</span><br />
            {t('calculate')} <span className="text-grey-800 font-bold">3(6) = 18</span><br />
            LHS = RHS
          </p>
        );
      default:
    ...
    if (mode === 'solve' || showExplanation) {
      ...
      return (
        ...
        <div className="w-full text-center mb-4">
            ...
            <p className={`font-mono text-xl sm:text-2xl font-bold ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>3(X - 2) = X + 10</p>
        </div>
  ...
  const renderVerification = () => {
    return (
      <div className={`mt-6 p-4 rounded-lg shadow-inner ${theme === 'light' ? 'bg-indigo-50 text-indigo-800' : 'bg-gray-800 text-gray-200'}`}>
        ...
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('originalEquation')} <span className="text-yellow-400 font-bold">3(X - 2) = X + 10</span></p>
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('substitute')} <span className="text-yellow-400 font-bold">3(8 - 2) = 8 + 10</span></p>
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('calculate')} <span className="text-yellow-400 font-bold">3(6) = 18</span> ✅</p>
