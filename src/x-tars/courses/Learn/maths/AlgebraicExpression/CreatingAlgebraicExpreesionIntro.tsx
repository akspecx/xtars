...
const translations = {
  en: {
    ...
    reset: "🔄 Reset",
    intro_message: "The scale is balanced. On the left side you have 3 apples, and on the right side you have a weight of 12 grams. We want to find the weight of one apple.",
    explanation_line1: "For the left side, we can represent the weight by multiplying the number of apples, which is 3, by the weight of one apple.",
    explanation_line2: "On the right side, we have a known weight of 12 grams. Since the scale is balanced, we can use an equal sign.",
    explanation_line3: "Since we do not know the weight of one apple, we can represent this unknown value with the variable 'x'.",
    explanation_line4: "This gives us the final algebraic expression:",
    startMessage: "Welcome to the interactive balance scale. Click start to begin the lesson.",
    lhs_label_apples: "3 * weight of one apple",
    rhs_label_grams: "12g",
    final_equation: "3 * x = 12g"
  },
  hi: {
    ...
    reset: "🔄 रीसेट करें",
    intro_message: "तराजू संतुलित है। बाईं ओर आपके पास 3 सेब हैं, और दाईं ओर आपके पास 12 ग्राम का वजन है। हम एक सेब का वजन पता लगाना चाहते हैं।",
    explanation_line1: "बाईं ओर के लिए, हम वजन को सेबों की संख्या, जो 3 है, को एक सेब के वजन से गुणा करके दर्शा सकते हैं।",
    explanation_line2: "दाईं ओर, हमारे पास 12 ग्राम का ज्ञात वजन है। चूंकि तराजू संतुलित है, हम एक बराबर चिह्न का उपयोग कर सकते हैं।",
    explanation_line3: "चूंकि हमें एक सेब का वजन नहीं पता है, हम इस अज्ञात मान को 'x' चर से दर्शा सकते हैं।",
    explanation_line4: "इससे हमें अंतिम बीजीय व्यंजक मिलता है:",
    startMessage: "इंटरैक्टिव संतुलन पैमाने में आपका स्वागत है। पाठ शुरू करने के लिए 'शुरू करें' पर क्लिक करें।",
    lhs_label_apples: "3 * एक सेब का वजन",
    rhs_label_grams: "12 ग्राम",
    final_equation: "3x = 12g"
  }
};
      ...
      const runLessonSequence = async () => {
        if (audioEnabled && userInteraction) {
          ...
          setTimeout(() => {
            ...
            speakMessage('explanation_line3');
            setShowLhsExpression(true);
            setShowRhsExpression(true);
          }, 9000);

          setTimeout(() => {
            speakMessage('explanation_line4');
          }, 12000);

          setTimeout(() => {
            speakMessage('explanation_line5');
          }, 15000);

          setTimeout(() => {
            setShowFinalEquation(true);
            speakMessage('explanation_line6');
          }, 18000);
