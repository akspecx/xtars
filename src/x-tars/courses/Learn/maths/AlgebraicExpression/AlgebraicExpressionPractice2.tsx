...
const translations = {
  en: {
    ...
    correctAnswer: "🎉 Correct! The weight of one apple is 4 grams!",
    incorrectAnswer: "❌ Incorrect. Please try again.",

    // Solving Equations Module
    solveEquationIntro: {
      text: "Now that you understand the principle of balance, let's use it to solve a more complex equation. On the left side, we have four apples and a 5 gram weight. On the right, we have two apples and a 13 gram weight. The scale is balanced.",
    ...
    equationSteps: [
      {
        step: 1,
        equation: "4X + 5 = 2X + 13",
        explanation: "The equation '4 * weight of one apple + 5 = 2 * weight of one apple + 13' shows our balanced scale in math form. We use X to represent the unknown weight of each apple, so we can write it as 4X + 5 = 2X + 13.",
        voice: "The equation 4 times weight of one apple, plus 5, equals 2 times weight of one apple, plus 13. We use X to represent the unknown weight of each apple, so we can write it as 4X plus 5 equals 2X plus 13."
      },
      {
        step: 2,
        equation: "4X + 5 - 2X = 2X + 13 - 2X",
        explanation: "Our goal is to get all the apples on one side. To do this, we need to remove the '2X' from the right side. We do this by subtracting 2X from both sides of the equation. This is a crucial step because whatever we do to one side, we must do to the other to keep the equation balanced.",
        voice: "Our goal is to get all the apples on one side. To do this, we need to remove the '2X' from the right side. We do this by subtracting 2X from both sides of the equation. This is a crucial step because whatever we do to one side, we must do to the other to keep the equation balanced."
      },
      {
        step: 3,
        equation: "2X + 5 = 13",
        explanation: "After subtracting 2X from both sides, the equation becomes 2X + 5 = 13. We now have 2 apples and a 5 gram weight on the left, and a total weight of 13 grams on the right.",
        voice: "After subtracting 2X from both sides, the equation becomes 2X equals 13. We now have 2 apples and a 5 gram weight on the left, and a total weight of 13 grams on the right."
      },
      {
        step: 4,
        equation: "2X + 5 - 5 = 13 - 5",
        explanation: "Now we need to isolate the apples. We do this by removing the '5 gm' weight by subtracting 5 from both sides of the equation.",
        voice: "Now we need to isolate the apples. We do this by removing the '5 gm' weight by subtracting 5 from both sides of the equation."
      },
      {
        step: 5,
        equation: "2X = 8",
        explanation: "After subtracting 5 from both sides, the equation becomes 2X = 8. We now have 2 apples on the left, and a total weight of 8 grams on the right.",
        voice: "After subtracting 5 from both sides, the equation becomes 2X equals 8. We now have 2 apples on the left, and a total weight of 8 grams on the right."
      },
      {
        step: 6,
        equation: "2X / 2 = 8 / 2",
        explanation: "Now we have 2 apples that equal 8 grams. To find the weight of a single apple, we need to get rid of the '2' (the coefficient). We do this by dividing both sides by the number of apples, which is 2. This makes the coefficient of X equal to 1.",
        voice: "Now we have 2 apples that equal 8 grams. To find the weight of a single apple, we need to get rid of the '2' (the coefficient). We do this by dividing both sides by the number of apples, which is 2. This makes the coefficient of X equal to 1."
      },
      {
        step: 7,
        equation: "X = 4",
        explanation: "By dividing both sides by 2, we get our final answer: X = 4. This means each apple weighs 4 grams!",
        voice: "By dividing both sides by 2, we get X equals 4. This means each apple weighs 4 grams!"
      },
      {
        step: 8,
        equation: "Final Verification",
        explanation: "Now let's verify our answer. Since we found that each apple weighs 4 grams, the left side is 4 times 4 plus 5, which equals 21. The right side is 2 times 4 plus 13, which also equals 21. The scale remains balanced!",
        voice: "Now let's verify our answer. The left side is 4 times 4 plus 5, which equals 21. The right side is 2 times 4 plus 13, which also equals 21. The scale is balanced."
      }
    ],
    continue: "Continue",
    solve: "Solve",
  ...
  hi: {
    ...
    correctAnswer: "🎉 सही! एक सेब का वजन 4 ग्राम है!",
    incorrectAnswer: "❌ गलत। कृपया पुनः प्रयास करें।",

    // Solving Equations Module
    solveEquationIntro: {
      text: "अब जब आप संतुलन के सिद्धांत को समझ गए हैं, तो आइए इसका उपयोग एक अधिक जटिल समीकरण को हल करने के लिए करें। बाईं ओर, हमारे पास चार सेब और 5 ग्राम का वजन है। दाईं ओर, हमारे पास दो सेब और 13 ग्राम का वजन है। पैमाना संतुलित है।",
    ...
    equationSteps: [
      {
        step: 1,
        equation: "4X + 5 = 2X + 13",
        explanation: "समीकरण '4 * एक सेब का वजन + 5 = 2 * एक सेब का वजन + 13' गणितीय रूप में हमारे संतुलित पैमाने को दर्शाता है। हम प्रत्येक सेब के अज्ञात वजन को दर्शाने के लिए X का उपयोग करते हैं, इसलिए हम इसे 4X + 5 = 2X + 13 के रूप में लिख सकते हैं।",
        voice: "समीकरण 4 गुना एक सेब का वजन, प्लस 5, बराबर 2 गुना एक सेब का वजन, प्लस 13 है। हम प्रत्येक सेब के अज्ञात वजन को दर्शाने के लिए X का उपयोग करते हैं, इसलिए हम इसे 4X प्लस 5 बराबर 2X प्लस 13 के रूप में लिख सकते हैं।"
      },
      {
        step: 2,
        equation: "4X + 5 - 2X = 2X + 13 - 2X",
        explanation: "हमारा लक्ष्य सभी सेबों को एक तरफ लाना है। ऐसा करने के लिए, हमें दाईं ओर से '2X' को हटाना होगा। हम समीकरण के दोनों पक्षों से 2X घटाकर ऐसा करते हैं। यह एक महत्वपूर्ण कदम है क्योंकि हम एक तरफ जो कुछ भी करते हैं, उसे समीकरण को संतुलित रखने के लिए दूसरी तरफ भी करना चाहिए।",
        voice: "हमारा लक्ष्य सभी सेबों को एक तरफ लाना है। हम समीकरण के दोनों पक्षों से 2X घटाकर ऐसा करते हैं।"
      },
      {
        step: 3,
        equation: "2X + 5 = 13",
        explanation: "दोनों पक्षों से 2X घटाने के बाद, समीकरण 2X = 13 हो जाता है। अब हमारे पास बाईं ओर 2 सेब और 5 ग्राम का वजन है, और दाईं ओर 13 ग्राम का कुल वजन है।",
        voice: "दोनों पक्षों से 2X घटाने के बाद, समीकरण 2X बराबर 13 हो जाता है। यह सरल है।"
      },
      {
        step: 4,
        equation: "2X + 5 - 5 = 13 - 5",
        explanation: "अब हमें सेबों को अलग करना है। हम समीकरण के दोनों पक्षों से 5 घटाकर '5 ग्राम' वजन को हटाते हैं।",
        voice: "अब हमें सेबों को अलग करना है। हम समीकरण के दोनों पक्षों से 5 घटाकर '5 ग्राम' वजन को हटाते हैं।"
      },
      {
        step: 5,
        equation: "2X = 8",
        explanation: "दोनों पक्षों से 5 घटाने के बाद, समीकरण 2X = 8 हो जाता है। अब हमारे पास बाईं ओर 2 सेब और दाईं ओर कुल 8 ग्राम वजन है।",
        voice: "दोनों पक्षों से 5 घटाने के बाद, समीकरण 2X बराबर 8 हो जाता है। अब हमारे पास बाईं ओर 2 सेब और दाईं ओर कुल 8 ग्राम वजन है।"
      },
      {
        step: 6,
        equation: "2X / 2 = 8 / 2",
        explanation: "अब हमारे पास 2 सेब हैं जिनका वजन 8 ग्राम है। एक सेब का वजन पता लगाने के लिए, हमें दोनों पक्षों को सेब की संख्या, जो कि 2 है, से भाग देना होगा। इससे X का गुणांक 1 हो जाएगा।",
        voice: "अब हमारे पास 2 सेब हैं जिनका वजन 8 ग्राम है। एक सेब का वजन पता लगाने के लिए, हम दोनों पक्षों को 2 से भाग देते हैं।"
      },
      {
        step: 7,
        equation: "X = 4",
        explanation: "दोनों पक्षों को 2 से भाग देने पर, हमें हमारा अंतिम उत्तर मिलता है: X = 4। इसका मतलब है कि प्रत्येक सेब का वजन 4 ग्राम है!",
        voice: "दोनों पक्षों को 2 से भाग देने पर, हमें X बराबर 4 मिलता है। इसका मतलब है कि प्रत्येक सेब का वजन 4 ग्राम है!"
      },
      {
        step: 8,
        equation: "Final Verification",
        explanation: "अब आइए अपने उत्तर को सत्यापित करें। चूंकि हमें पता चला कि प्रत्येक सेब का वजन 4 ग्राम है, तो बायां पक्ष 4 गुना 4 प्लस 5 है, जो 21 के बराबर है। दायां पक्ष 2 गुना 4 प्लस 13 है, जो भी 21 के बराबर है। पैमाना संतुलित रहता है!",
        voice: "अब आइए अपने उत्तर को सत्यापित करें। बायां पक्ष 4 गुना 4 प्लस 5 है, जो 21 के बराबर है। दायां पक्ष 2 गुना 4 प्लस 13 है, जो भी 21 के बराबर है। पैमाना संतुलित है।"
      }
    ],
    continue: "जारी रखें",
    solve: "हल करें",
...
const App = () => {
  ...
  const [leftPanWeight, setLeftPanWeight] = useState({ apples: 4, value: 5 });
  const [rightPanWeight, setRightPanWeight] = useState({ apples: 2, value: 13 });
  ...
  const handleStartSolving = () => {
    setMode('solve');
    setLeftPanWeight({ apples: 4, value: 5 });
    setRightPanWeight({ apples: 2, value: 13 });
    setBalanceTilt(0);
    setEquationStep(1);
  ...
  const renderEquationTextWithHighlight = (equation, step) => {
    switch (step) {
      case 2:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            4X + 5 <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">- 2X</span> = 2X + 13 <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">- 2X</span>
          </p>
        );
      case 3:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">2X + 5</span> = <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">13</span>
          </p>
        );
      case 4:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            2X + 5 <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">- 5</span> = 13 <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">- 5</span>
          </p>
        );
      case 5:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">2X</span> = <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">8</span>
          </p>
        );
      case 6:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">2</span>X / <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">2</span> = 8 / <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">2</span>
          </p>
        );
      case 7:
        return (
      ...
      case 8:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            {t('originalEquation')} <span className="text-grey-800 font-bold">4X + 5 = 2X + 13</span><br />
            {t('substitute')} <span className="text-grey-800 font-bold">4({`4`}) + 5 = 2({`4`}) + 13</span><br />
            {t('calculate')} <span className="text-grey-800 font-bold">16 + 5 = 8 + 13</span><br />
            LHS = RHS
          </p>
        );
      default:
  ...
  const renderVerification = () => {
    return (
      <div className={`mt-6 p-4 rounded-lg shadow-inner ${theme === 'light' ? 'bg-indigo-50 text-indigo-800' : 'bg-gray-800 text-gray-200'}`}>
        ...
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('originalEquation')} <span className="text-yellow-400 font-bold">4X + 5 = 2X + 13</span></p>
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('substitute')} <span className="text-yellow-400 font-bold">4({`4`}) + 5 = 2({`4`}) + 13</span></p>
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('calculate')} <span className="text-yellow-400 font-bold">16 + 5 = 8 + 13</span> ✅</p>
