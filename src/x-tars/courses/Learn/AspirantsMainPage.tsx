        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm font-semibold text-[#A68B7C] leading-none mt-0.5">What do you want to learn today, Aspirant?</p>
            </div>
          </div>
          <div className="flex flex-col items-center bg-[#4CAF50] px-4 py-2 rounded-xl text-white shadow-[0_4px_0_#388E3C] border-2 border-white transform rotate-1 shrink-0">
            ...
            <span className="text-2xl font-black leading-none">{ASPIRANTS_DATA.length}</span>
          </div>
        </motion.div>
