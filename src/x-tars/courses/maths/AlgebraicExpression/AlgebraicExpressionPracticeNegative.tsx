...
const translations = {
  en: {
    ...
    correctAnswer: "🎉 Correct! The weight of one apple is 9 grams!",
    incorrectAnswer: "❌ Incorrect. Please try again.",

    // Solving Equations Module
    solveEquationIntro: {
      text: "Now that you understand the principle of balance, let's use it to solve an equation. On the left side, we have three apples and a 1 gram weight. On the right, we have a 7 gram weight. The scale is balanced.",
    ...
    equationSteps: [
      {
        step: 1,
        equation: "3X - 9 = 18",
        explanation: "The equation '3 * weight of one apple - 9 = 18' shows our balanced scale in math form. We use X to represent the unknown weight of each apple, so we can write it as 3X - 9 = 18.",
        voice: "The equation 3 times weight of one apple, minus 9, equals 18. We use X to represent the unknown weight of each apple, so we can write it as 3X minus 9 equals 18."
      },
      {
        step: 2,
        equation: "3X - 9 + 9 = 18 + 9",
        explanation: "Our goal is to get the apples by themselves on one side. To do this, we need to remove the '-9 gm' weight. We do this by adding 9 to both sides of the equation. This is a crucial step because whatever we do to one side, we must do to the other to keep the equation balanced.",
        voice: "Our goal is to get the apples by themselves on one side. To do this, we need to remove the '-9 gm' weight. We do this by adding 9 to both sides of the equation. This is a crucial step because whatever we do to one side, we must do to the other to keep the equation balanced."
      },
      {
        step: 3,
        equation: "3X = 27",
        explanation: "After adding 9 to both sides, the equation becomes 3X = 27. We now have 3 apples on the left, and a total weight of 27 grams on the right.",
        voice: "After adding 9 to both sides, the equation becomes 3X equals 27. We now have 3 apples on the left, and a total weight of 27 grams on the right."
      },
      {
        step: 4,
        equation: "3X / 3 = 27 / 3",
        explanation: "Now we have 3 apples that equal 27 grams. To find the weight of a single apple, we need to get rid of the '3' (the coefficient). We do this by dividing both sides by the number of apples, which is 3. This makes the coefficient of X equal to 1.",
        voice: "Now we have 3 apples that equal 27 grams. To find the weight of a single apple, we need to get rid of the '3' (the coefficient). We do this by dividing both sides by the number of apples, which is 3. This makes the coefficient of X equal to 1.",
      },
      {
        step: 5,
        equation: "X = 9",
        explanation: "By dividing both sides by 3, we get our final answer: X = 9. This means each apple weighs 9 grams!",
        voice: "By dividing both sides by 3, we get X equals 9. This means each apple weighs 9 grams!"
      },
      {
        step: 6,
        equation: "Final Verification",
        explanation: "Now let's verify our answer. Since we found that each apple weighs 9 grams, the left side of the scale is 3 times 9 minus 9, which equals 18. This is the same as the right side, so the scale remains balanced!",
        voice: "Now let's verify our answer. The left side is 3 times 9 minus 9, which equals 18. This is the same as the right side, so the scale is balanced.",
      }
    ],
    continue: "Continue",
    solve: "Solve",
    ...
    substitute: "Substitute X = 9:",
    calculate: "Calculate:",
    perfect: "✅ Perfect! Each apple weighs exactly 9 grams!",
  },
  hi: {
    ...
    correctAnswer: "🎉 सही! एक सेब का वजन 9 ग्राम है!",
    incorrectAnswer: "❌ गलत। कृपया पुनः प्रयास करें।",

    // Solving Equations Module
    solveEquationIntro: {
      text: "अब जब आप संतुलन के सिद्धांत को समझ गए हैं, तो आइए इसका उपयोग एक समीकरण को हल करने के लिए करें। बाईं ओर, हमारे पास तीन सेब और 1 ग्राम का वजन है। दाईं ओर, हमारे पास 7 ग्राम का वजन है। पैमाना संतुलित है।",
    ...
    equationSteps: [
      {
        step: 1,
        equation: "3X - 9 = 18",
        explanation: "समीकरण '3 * एक सेब का वजन - 9 = 18' गणितीय रूप में हमारे संतुलित पैमाने को दर्शाता है। हम प्रत्येक सेब के अज्ञात वजन को दर्शाने के लिए X का उपयोग करते हैं, इसलिए हम इसे 3X - 9 = 18 के रूप में लिख सकते हैं।",
        voice: "समीकरण '3 * एक सेब का वजन - 9 = 18' गणितीय रूप में हमारे संतुलित पैमाने को दर्शाता है। हम प्रत्येक सेब के अज्ञात वजन को दर्शाने के लिए X का उपयोग करते हैं, इसलिए हम इसे 3X - 9 = 18 के रूप में लिख सकते हैं।"
      },
      {
        step: 2,
        equation: "3X - 9 + 9 = 18 + 9",
        explanation: "हमारा लक्ष्य एक तरफ सेब को अकेले रखना है। ऐसा करने के लिए, हमें -9 ग्राम वजन को हटाना होगा। हम समीकरण के दोनों पक्षों में 9 जोड़कर ऐसा करते हैं। जैसा कि हमने सीखा, समीकरण को संतुलित रखने के लिए हम एक तरफ जो कुछ भी करते हैं, उसे दूसरी तरफ भी करना चाहिए।",
        voice: "हमारा लक्ष्य सेब को अकेले रखना है। हम समीकरण को संतुलित रखने के लिए दोनों पक्षों में 9 जोड़ते हैं।"
      },
      {
        step: 3,
        equation: "3X = 27",
        explanation: "दोनों पक्षों में 9 जोड़ने के बाद, समीकरण 3X = 27 हो जाता है। अब हमारे पास बाईं ओर 3 सेब और दाईं ओर कुल 27 ग्राम वजन है।",
        voice: "दोनों पक्षों में 9 जोड़ने के बाद, समीकरण 3X बराबर 27 हो जाता है। यह सरल है।"
      },
      {
        step: 4,
        equation: "3X / 3 = 27 / 3",
        explanation: "अब हमारे पास 3 सेब हैं जिनका वजन 27 ग्राम है। एक सेब का वजन पता लगाने के लिए, हमें दोनों पक्षों को सेब की संख्या, जो कि 3 है, से भाग देना होगा। इससे X का गुणांक 1 हो जाएगा।",
        voice: "अब हमारे पास 3 सेब हैं जिनका वजन 27 ग्राम है। एक सेब का वजन पता लगाने के लिए, हम दोनों पक्षों को 3 से भाग देते हैं।"
      },
      {
        step: 5,
        equation: "X = 9",
        explanation: "दोनों पक्षों को 3 से भाग देने पर, हमें हमारा अंतिम उत्तर मिलता है: X = 9। इसका मतलब है कि प्रत्येक सेब का वजन 9 ग्राम है!",
        voice: "दोनों पक्षों को 3 से भाग देने पर, हमें X बराबर 9 मिलता है। इसका मतलब है कि प्रत्येक सेब का वजन 9 ग्राम है!"
      },
      {
        step: 6,
        equation: "Final Verification",
        explanation: "अब आइए अपने उत्तर को सत्यापित करें। चूंकि हमें पता चला कि प्रत्येक सेब का वजन 9 ग्राम है, तो पैमाने का बायां पक्ष 3 गुना 9 माइनस 9 है, जो 18 के बराबर है। यह दाईं ओर के वजन के समान है, इसलिए पैमाना संतुलित रहता है!",
        voice: "अब आइए अपने उत्तर को सत्यापित करें। बायां पक्ष 3 गुना 9 माइनस 9 है, जो 18 के बराबर है। यह दाईं ओर के वजन के समान है, इसलिए पैमाना संतुलित है।",
      }
    ],
    continue: "जारी रखें",
    solve: "हल करें",
    ...
    substitute: "X = 9 रखें:",
    calculate: "गणना करें:",
    perfect: "✅ बिलकुल सही! प्रत्येक सेब का वजन ठीक 9 ग्राम है!",
  },
};
...
const App = () => {
  ...
  const [leftPanWeight, setLeftPanWeight] = useState({ apples: 3, value: -9 });
  const [rightPanWeight, setRightPanWeight] = useState(18);
  ...
  const handleStartSolving = () => {
    setMode('solve');
    setLeftPanWeight({ apples: 3, value: -9 });
    setRightPanWeight(18);
    setBalanceTilt(0);
    setEquationStep(1);
  ...
  const renderWeight = () => {
    const appleItems = Array.from({ length: 3 }, (_, i) => (
      ...
      case 2:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            3X <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">- 9</span> + <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">9</span> = 18 + <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">9</span>
          </p>
        );
      case 4:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">3</span>X / <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">3</span> = 27 / <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">3</span>
          </p>
        );
      case 5:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            X = <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">9</span>
          </p>
        );
      case 6:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            {t('originalEquation')} <span className="text-grey-800 font-bold">3X - 9 = 18</span><br />
            {t('substitute')} <span className="text-grey-800 font-bold">3*{`9`} - 9 = 18</span><br />
            {t('calculate')} <span className="text-grey-800 font-bold">27 - 9 = 18</span><br />
            LHS = RHS
          </p>
        );
      default:
  ...
  const renderVerification = () => {
    return (
      <div className={`mt-6 p-4 rounded-lg shadow-inner ${theme === 'light' ? 'bg-indigo-50 text-indigo-800' : 'bg-gray-800 text-gray-200'}`}>
        ...
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('originalEquation')} <span className="text-yellow-400 font-bold">3X - 9 = 18</span></p>
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('substitute')} <span className="text-yellow-400 font-bold">3(9) - 9 = ?</span></p>
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('calculate')} <span className="text-yellow-400 font-bold">27 - 9 = 18</span> ✅</p>
