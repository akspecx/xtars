...
const translations = {
  en: {
    ...
    correctAnswer: "🎉 Correct! The answer is 4!",
    incorrectAnswer: "❌ Incorrect. Please try again.",

    // Solving Equations Module
    solveEquationIntro: {
      text: "5X - 3 = 2X + 9. Can you find the value of X?",
      voice: "5X minus 3 equals 2X plus 9. Can you find the value of X?",
    },
    equationSteps: [
      {
        step: 1,
        equation: "5X - 3 = 2X + 9",
        explanation: "The equation '5X - 3 = 2X + 9' is what we need to solve. Our goal is to get the X terms on one side and the numbers on the other.",
        voice: "The equation 5X minus 3 equals 2X plus 9 is what we need to solve. Our goal is to get the X terms on one side and the numbers on the other."
      },
      {
        step: 2,
        equation: "5X - 2X - 3 = 2X - 2X + 9",
        explanation: "To get all the X terms on one side, we need to remove the '2X' from the right side. We do this by subtracting 2X from both sides of the equation. This keeps the equation balanced.",
        voice: "To get all the X terms on one side, we subtract 2X from both sides."
      },
      {
        step: 3,
        equation: "3X - 3 = 9",
        explanation: "After subtracting 2X from both sides, the equation simplifies to 3X - 3 = 9. Now, we have all the X terms on one side.",
        voice: "After subtracting 2X from both sides, the equation simplifies to 3X minus 3 equals 9."
      },
      {
        step: 4,
        equation: "3X - 3 + 3 = 9 + 3",
        explanation: "To get the X term by itself, we need to remove the '-3' from the left side. We do this by adding 3 to both sides of the equation.",
        voice: "To get the X term by itself, we add 3 to both sides of the equation."
      },
      {
        step: 5,
        equation: "3X = 12",
        explanation: "After adding 3 to both sides, the equation simplifies to 3X = 12.",
        voice: "After adding 3 to both sides, the equation simplifies to 3X equals 12."
      },
      {
        step: 6,
        equation: "3X / 3 = 12 / 3",
        explanation: "Now, to find the value of a single 'X', we need to remove the coefficient '3'. We do this by dividing both sides by 3.",
        voice: "Now, to find the value of a single X, we divide both sides by 3."
      },
      {
        step: 7,
        equation: "X = 4",
        explanation: "By dividing both sides by 3, we get our final answer: X = 4.",
        voice: "By dividing both sides by 3, we get X equals 4."
      },
      {
        step: 8,
        equation: "Final Verification",
        explanation: "Now let's verify our answer. Substitute X = 4 back into the original equation: 5(4) - 3 = 2(4) + 9 which simplifies to 20 - 3 = 8 + 9. Both sides equal 17. This is correct!",
        voice: "Now let's verify our answer. The left side is 5 times 4 minus 3, which equals 17. The right side is 2 times 4 plus 9, which also equals 17. The equation is balanced!"
      }
    ],
    continue: "Continue",
    solve: "Solve",
  ...
  hi: {
    ...
    correctAnswer: "🎉 सही! उत्तर 4 है!",
    incorrectAnswer: "❌ गलत। कृपया पुनः प्रयास करें।",

    // Solving Equations Module
    solveEquationIntro: {
      text: "5X - 3 = 2X + 9. क्या आप X का मान ज्ञात कर सकते हैं?",
      voice: "5X माइनस 3 बराबर 2X प्लस 9। क्या आप X का मान ज्ञात कर सकते हैं?"
    },
    equationSteps: [
      {
        step: 1,
        equation: "5X - 3 = 2X + 9",
        explanation: "समीकरण '5X - 3 = 2X + 9' हमें हल करने के लिए दिया गया है। हमारा लक्ष्य X पदों को एक तरफ और संख्याओं को दूसरी तरफ लाना है।",
        voice: "समीकरण 5X माइनस 3 बराबर 2X प्लस 9 है। हमारा लक्ष्य X पदों को एक तरफ और संख्याओं को दूसरी तरफ लाना है।"
      },
      {
        step: 2,
        equation: "5X - 2X - 3 = 2X - 2X + 9",
        explanation: "सभी X पदों को एक तरफ लाने के लिए, हमें दाईं ओर से '2X' को हटाना होगा। हम समीकरण के दोनों पक्षों से 2X घटाकर ऐसा करते हैं। यह समीकरण को संतुलित रखता है।",
        voice: "सभी X पदों को एक तरफ लाने के लिए, हम दोनों पक्षों से 2X घटाते हैं।"
      },
      {
        step: 3,
        equation: "3X - 3 = 9",
        explanation: "दोनों पक्षों से 2X घटाने के बाद, समीकरण 3X - 3 = 9 हो जाता है। अब, हमारे पास सभी X पद एक तरफ हैं।",
        voice: "दोनों पक्षों से 2X घटाने के बाद, समीकरण 3X माइनस 3 बराबर 9 हो जाता है।"
      },
      {
        step: 4,
        equation: "3X - 3 + 3 = 9 + 3",
        explanation: "X पद को अकेले प्राप्त करने के लिए, हमें बाईं ओर से '-3' को हटाना होगा। हम समीकरण के दोनों पक्षों में 3 जोड़कर ऐसा करते हैं।",
        voice: "X पद को अकेले प्राप्त करने के लिए, हम दोनों पक्षों में 3 जोड़ते हैं।"
      },
      {
        step: 5,
        equation: "3X = 12",
        explanation: "दोनों पक्षों में 3 जोड़ने के बाद, समीकरण 3X = 12 हो जाता है।",
        voice: "दोनों पक्षों में 3 जोड़ने के बाद, समीकरण 3X बराबर 12 हो जाता है।"
      },
      {
        step: 6,
        equation: "3X / 3 = 12 / 3",
        explanation: "अब, एक 'X' का मान ज्ञात करने के लिए, हमें गुणांक '3' को हटाना होगा। हम समीकरण के दोनों पक्षों को 3 से भाग देकर ऐसा करते हैं।",
        voice: "अब, एक X का मान ज्ञात करने के लिए, हम दोनों पक्षों को 3 से भाग देते हैं।"
      },
      {
        step: 7,
        equation: "X = 4",
        explanation: "दोनों पक्षों को 3 से भाग देने पर, हमें हमारा अंतिम उत्तर मिलता है: X = 4।",
        voice: "दोनों पक्षों को 3 से भाग देने पर, हमें X बराबर 4 मिलता है।"
      },
      {
        step: 8,
        equation: "Final Verification",
        explanation: "अब आइए अपने उत्तर की जाँच करें। X = 4 को मूल समीकरण में रखें: 5(4) - 3 = 2(4) + 9 जो 20 - 3 = 8 + 9 हो जाता है। दोनों पक्ष 17 के बराबर हैं। यह सही है!",
        voice: "अब आइए अपने उत्तर की जाँच करें। बायां पक्ष 5 गुना 4 माइनस 3 है, जो 17 के बराबर है। दायां पक्ष 2 गुना 4 प्लस 9 है, जो भी 17 के बराबर है। समीकरण संतुलित है।"
      }
    ],
    continue: "जारी रखें",
    solve: "हल करें",
  ...
  const renderEquationTextWithHighlight = (equation, step) => {
    switch (step) {
      case 2:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            5X - 3 <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">- 2X</span> = 2X + 9 <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">- 2X</span>
          </p>
        );
      case 3:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">3X - 3</span> = <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">9</span>
          </p>
        );
      case 4:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            3X - 3 <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">+ 3</span> = 9 <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">+ 3</span>
          </p>
        );
      case 5:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">3X</span> = <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">12</span>
          </p>
        );
      case 6:
        return (
      ...
      case 8:
        return (
          <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>
            {t('originalEquation')} <span className="text-grey-800 font-bold">5X - 3 = 2X + 9</span><br />
            {t('substitute')} <span className="text-grey-800 font-bold">5({`4`}) - 3 = 2({`4`}) + 9</span><br />
            {t('calculate')} <span className="text-grey-800 font-bold">20 - 3 = 8 + 9</span><br />
            LHS = RHS
          </p>
        );
      default:
    ...
    if (mode === 'solve' || showExplanation) {
      ...
      return (
        ...
        <div className="w-full text-center mb-4">
            ...
            <p className={`font-mono text-xl sm:text-2xl font-bold ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>5X - 3 = 2X + 9</p>
        </div>
  ...
  const renderVerification = () => {
    return (
      <div className={`mt-6 p-4 rounded-lg shadow-inner ${theme === 'light' ? 'bg-indigo-50 text-indigo-800' : 'bg-gray-800 text-gray-200'}`}>
        ...
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('originalEquation')} <span className="text-yellow-400 font-bold">5X - 3 = 2X + 9</span></p>
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('substitute')} <span className="text-yellow-400 font-bold">5({`4`}) - 3 = 2({`4`}) + 9</span></p>
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('calculate')} <span className="text-yellow-400 font-bold">20 - 3 = 8 + 9</span> ✅</p>
