...
const translations = {
  en: {
    ...
    equationSteps: [
      {
        step: 1,
        equation: "2X - 3 = 5",
        explanation: "The equation '2 * weight of one apple - 3 = 5' shows our balanced scale in math form. We use X to represent the unknown weight of each apple, so we can write it as 2X - 3 = 5.",
        voice: "The equation 2 times weight of one apple, minus 3, equals 5. We use X to represent the unknown weight of each apple, so we can write it as 2X minus 3 equals 5."
      },
      {
        step: 2,
        equation: "2X - 3 + 3 = 5 + 3",
        explanation: "Our goal is to get the apples by themselves on one side. To do this, we need to remove the '-3 gm' weight. We do this by adding 3 to both sides of the equation. This is a crucial step because whatever we do to one side, we must do to the other to keep the equation balanced.",
        voice: "Our goal is to get the apples by themselves on one side. To do this, we need to remove the '-3 gm' weight. We do this by adding 3 to both sides of the equation. This is a crucial step because whatever we do to one side, we must do to the other to keep the equation balanced."
      },
      {
        step: 3,
        equation: "2X = 8",
        explanation: "After adding 3 to both sides, the equation becomes 2X = 8. We now have 2 apples on the left, and a total weight of 8 grams on the right.",
        voice: "After adding 3 to both sides, the equation becomes 2X = 8. We now have 2 apples on the left, and a total weight of 8 grams on the right."
      },
      {
        step: 4,
        equation: "2X / 2 = 8 / 2",
      ...
      },
      {
        ...
        explanation: "Now let's verify our answer. Since we found that each apple weighs 4 grams, the left side of the scale is 2 times 4 minus 3, which equals 5. This is the same as the right side, so the scale remains balanced!",
        voice: "Now let's verify our answer. The left side is 2 times 4 minus 3, which equals 5. This is the same as the right side, so the scale is balanced.",
      }
    ],
    continue: "Continue",
    solve: "Solve",
    ...
    calculate: "Calculate:",
    perfect: "✅ Perfect! Each apple weighs exactly 4 grams!",
  },
  hi: {
    ...
    equationSteps: [
      {
        step: 1,
        equation: "2X - 3 = 5",
        explanation: "समीकरण '2 * एक सेब का वजन - 3 = 5' गणितीय रूप में हमारे संतुलित पैमाने को दर्शाता है। हम प्रत्येक सेब के अज्ञात वजन को दर्शाने के लिए X का उपयोग करते हैं, इसलिए हम इसे 2X - 3 = 5 के रूप में लिख सकते हैं।",
        voice: "समीकरण '2 * एक सेब का वजन - 3 = 5' गणितीय रूप में हमारे संतुलित पैमाने को दर्शाता है। हम प्रत्येक सेब के अज्ञात वजन को दर्शाने के लिए X का उपयोग करते हैं, इसलिए हम इसे 2X - 3 = 5 के रूप में लिख सकते हैं।"
      },
      {
        step: 2,
        equation: "2X - 3 + 3 = 5 + 3",
        explanation: "हमारा लक्ष्य एक तरफ सेब को अकेले रखना है। ऐसा करने के लिए, हमें -3 ग्राम वजन को हटाना होगा। हम समीकरण के दोनों पक्षों में 3 जोड़कर ऐसा करते हैं। जैसा कि हमने सीखा, समीकरण को संतुलित रखने के लिए हम एक तरफ जो कुछ भी करते हैं, उसे दूसरी तरफ भी करना चाहिए।",
        voice: "हमारा लक्ष्य सेब को अकेले रखना है। हम समीकरण को संतुलित रखने के लिए दोनों पक्षों में 3 जोड़ते हैं।"
      },
      {
        step: 3,
        equation: "2X = 8",
        explanation: "दोनों पक्षों में 3 जोड़ने के बाद, समीकरण 2X = 8 हो जाता है। अब हमारे पास बाईं ओर 2 सेब और दाईं ओर कुल 8 ग्राम वजन है।",
        voice: "दोनों पक्षों में 3 जोड़ने के बाद, समीकरण 2X बराबर 8 हो जाता है। यह सरल है।"
      },
      {
        step: 4,
        equation: "2X / 2 = 8 / 2",
      ...
      },
      {
        step: 6,
        equation: "Final Verification",
        explanation: "अब आइए अपने उत्तर को सत्यापित करें। चूंकि हमें पता चला कि प्रत्येक सेब का वजन 4 ग्राम है, तो पैमाने का बायां पक्ष 2 गुना 4 माइनस 3 है, जो 5 के बराबर है। यह दाईं ओर के वजन के समान है, इसलिए पैमाना संतुलित रहता है!",
        voice: "अब आइए अपने उत्तर को सत्यापित करें। बायां पक्ष 2 गुना 4 माइनस 3 है, जो 5 के बराबर है। यह दाईं ओर के वजन के समान है, इसलिए पैमाना संतुलित है।",
      }
    ],
    continue: "जारी रखें",
    solve: "हल करें",
    ...
    substitute: "X = 4 रखें:",
    calculate: "गणना करें:",
    perfect: "✅ बिलकुल सही! प्रत्येक सेब का वजन ठीक 4 ग्राम है!",
  },
};
...
const App = () => {
  ...
  const [leftPanWeight, setLeftPanWeight] = useState({ apples: 2, value: -3 });
  const [rightPanWeight, setRightPanWeight] = useState(5);
  ...
  useEffect(() => {
    if (equationMode && equationStep > 0 && equationStep <= 6) {
  ...
  const handleStartSolving = () => {
    ...
    setLeftPanWeight({ apples: 2, value: -3 });
    setRightPanWeight(5);
    setBalanceTilt(0);
    setEquationStep(1);
  };
  ...
  const renderWeight = () => {
    const appleItems = Array.from({ length: 2 }, (_, i) => (
      ...
      case 2:
        return (
          <p className="font-mono text-gray-800 dark:text-gray-200">
            2X <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">- 3</span> + <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">3</span> = 5 + <span className="ring-2 ring-yellow-400 ring-offset-2 rounded-full px-1">3</span>
          </p>
        );
      case 4:
        return (
  ...
  const renderCurrentStepContent = () => {
    ...
    if (equationStep > 0 && equationStep <= 5) {
  ...
  const renderVerification = () => {
    return (
      <div className={`mt-6 p-4 rounded-lg shadow-inner ${theme === 'light' ? 'bg-indigo-50 text-indigo-800' : 'bg-gray-800 text-gray-200'}`}>
        ...
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('originalEquation')} <span className="text-yellow-400 font-bold">2X - 3 = 5</span></p>
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('substitute')} <span className="text-yellow-400 font-bold">2(4) - 3 = ?</span></p>
        <p className={`font-mono ${theme === 'light' ? 'text-gray-800' : 'text-gray-200'}`}>{t('calculate')} <span className="text-yellow-400 font-bold">8 - 3 = 5</span> ✅</p>
            ...
            {equationStep < totalSteps && (
             ...
             {equationStep >= totalSteps && (
               <div className="mt-4 flex gap-4 w-full justify-center">
                 ...
                 <button
                   onClick={handleReset}
                   className="w-full px-6 py-3 bg-gray-600 text-white font-bold rounded-lg shadow-lg hover:bg-gray-700 transition-transform transform hover:scale-105 active:scale-95 text-lg"
                 >
                   {t('reset')}
                 </button>
               </div>
