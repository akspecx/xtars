...
const translations = {
  'en': {
    ...
    instruction1: "Annie is sitting **right** to Ninnie.",
    instruction2: "Vinnie is to the **immediate right** of Ninnie.",
    submitButton: "Submit",
    ...
    validationMessages: {
      instruction1: {
        pass: "✅ Correct! Annie's chair number is greater than Ninnie's.",
        fail: "❌ Incorrect! Annie should be in a chair with a number greater than Ninnie's."
      },
      instruction2: {
        pass: "✅ Correct! Vinnie's chair is exactly one number more than Ninnie's.",
        fail: "❌ Incorrect! Vinnie must be in the chair immediately to the right of Ninnie's."
      }
    },
    characterNames: {
      annie: "Annie",
  ...
  'hi': {
    ...
    instruction1: "एनी, निन्नी के **दाएँ** बैठी है।",
    instruction2: "विन्नी, निन्नी के **ठीक दाएँ** बैठी है।",
    ...
    validationMessages: {
      instruction1: {
        pass: "✅ सही! एनी की कुर्सी संख्या निन्नी की कुर्सी संख्या से अधिक है।",
        fail: "❌ गलत! एनी को निन्नी की कुर्सी से अधिक संख्या वाली कुर्सी में होना चाहिए।"
      },
      instruction2: {
        pass: "✅ सही! विन्नी की कुर्सी की संख्या निन्नी की कुर्सी की संख्या से ठीक एक अधिक है।",
        fail: "❌ गलत! विन्नी को निन्नी की कुर्सी के ठीक दाईं ओर वाली कुर्सी में होना चाहिए।"
      }
    },
    characterNames: {
      annie: "एनी",
...
const RightandImmediateRight = () => {
  ...
  const handleSubmit = () => {
    ...
    // New logic for 'right' and 'immediate right'
...
export default RightandImmediateRight;
