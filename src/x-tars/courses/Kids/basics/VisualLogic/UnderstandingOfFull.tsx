...
import {
  ...
  Trophy, Award, BatteryFull, Star, ShoppingBag
} from 'lucide-react';
...
export default function App() {
  ...
  const games = [
    ...
    'understandingofbelow',
    'understandingofbig',
    'understandingofsmall',
    'understandingoftall',
    'understandingofshort',
    'understandingoffull',
    'understandingofempty',
    'understandingofinside',
    'understandingofoutside',
    'understandingofaboveandbelow',
    'understandingofbigandsmallmix',
    'understandingoffullandemptymix',
  ...
  }, [fullSide, isAnswered, isCorrect, isAutoPlaying, mode, playThud, currentScenario.name, speak]);
                ...
                return (
                    <motion.button
                        ...
                        className={`relative flex-1 max-w-[340px] w-full h-full bg-[#FFFBF2] rounded-[1.2rem] sm:rounded-[2.5rem] shadow-[inset_0_4px_8px_rgba(0,0,0,0.02),0_8px_16px_rgba(0,0,0,0.08)] border-b-[4px] sm:border-b-[8px] flex flex-col items-center justify-center transition-all duration-500 overflow-hidden ${
                            isSelected 
                                ? (isCorrect && isFullSlot ? 'border-[#4CAF50] bg-[#F1FCEF]' : 'border-[#FFB74D] animate-wobble')
