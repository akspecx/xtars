/**
 * UnderstandingOfShort.tsx — Visual Logic module (TALL/SHORT)
...
const VOICE: VoiceScript = {
  ...
  correct:     (name, _l, kid) => `Yes! ${name} is SHORT! Great, ${kid}!`,
...
const DEFINITION   = `SHORT means something does not reach high — like a little flower pot or a tiny mushroom! 🍄`;
const ACCENT       = '#2D6A4F';
