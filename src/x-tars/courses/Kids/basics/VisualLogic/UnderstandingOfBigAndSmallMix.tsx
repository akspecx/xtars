/**
 * UnderstandingOfBigAndSmallMix.tsx — Visual Logic module (BIG/SMALL)
...
const VOICE: VoiceScript = {
  intro:       (_p, _s, kid) => `Hi ${kid}! Sometimes tap BIG, sometimes SMALL!`,
  question:    (lbl, kid)   => `${kid}, which one is ${lbl}?`,
  correct:     (name, _l, kid) => `Yes! ${name} is ${_l}! Amazing, ${kid}!`,
...
const MSG: AvatarMessages = {
  ...
  wrong:              `Look again! Think about size! 🤔`,
};

const DEFINITION   = `BIG takes up lots of space. SMALL is tiny and little. Can you tell which is which? 🐘🐜`;
const ACCENT       = '#2D6A4F';
