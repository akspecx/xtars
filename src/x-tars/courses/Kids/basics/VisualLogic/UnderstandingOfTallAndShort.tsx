/**
 * UnderstandingOfTallAndShort.tsx — Visual Logic module (TALL/SHORT)
...
const VOICE: VoiceScript = {
  intro:       (_p, _s, kid) => `Hi ${kid}! Tap TALL or SHORT — listen carefully!`,
  question:    (lbl, kid)   => `${kid}, which one is ${lbl}?`,
  correct:     (name, _l, kid) => `Yes! ${name} is ${_l}! You got it, ${kid}!`,
...
const MSG: AvatarMessages = {
  ...
  wrong:              `Look again! Think about height! 🤔`,
};

const DEFINITION   = `TALL reaches up high. SHORT does not reach up high. Look carefully! 🦒🍄`;
const ACCENT       = '#2D6A4F';
const PRIMARY_LBL  = 'TALL';
const SECONDARY_LBL = 'SHORT';
const MODULE_ID    = 'tall-short';
