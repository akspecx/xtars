...
export default function App() {
  ...
  const resetLevel = useCallback((idx: number, isSequential = false) => {
    ...
    // Randomize Challenge Goal (Inside vs Outside)
  ...
  const handleSelect = useCallback((side: string, isTutorial = false) => {
    ...
    // Logic: 
    // If target is 'inside', winner is 'insideSide'.
    // If target is 'outside', winner is the OTHER side.
            ...
            return (
              ...
              >
                <div className="relative w-full h-full flex items-center justify-center">
                  ...
                  <div className="relative w-full h-full flex items-center justify-center">
                    <motion.div
                      animate={{ scale: 1.0, x: isInsideSlot ? "0%" : "-15%", opacity: 1 }}
