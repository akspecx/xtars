...
import {
  ...
  Trophy, Award, PackageSearch, Star
} from 'lucide-react';
...
export default function App() {
  ...
  }, [insideSide, isAnswered, isCorrect, isAutoPlaying, mode, playThud, currentScenario.name, speak]);
            ...
            return (
              ...
              >
                <div className="relative w-full h-full flex items-center justify-center">
                  ...
                  <div className="relative w-full h-full flex items-center justify-center">
                    <motion.div
                      animate={{ scale: 1.0, x: isInsideSlot ? "0%" : "-15%" }}
