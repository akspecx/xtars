...
export default function App() {
  ...
  const handleSelect = useCallback((side, isTutorial = false) => {
    ...
    if (isWinnerSide) {
      ...
      setIsCorrect(false);
      playThud(100); 
      speak(`That one is ${targetType === 'full' ? 'empty' : 'full'}. Find the ${targetType} one!`);
      if (!isTutorial) {
        setTimeout(() => {
          setIsAnswered(false);
          setSelectedSide(null);
      ...
      <div className="w-full max-w-6xl flex flex-col md:flex-row justify-between items-center gap-6 mb-8">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 sm:w-20 sm:h-20 bg-[#D9B99B] rounded-3xl shadow-[0_8px_0_#B8977E] flex items-center justify-center text-white border-2 border-[#EADAC4]">
              ...
              >
                {targetType === 'full' ? <BatteryFull size={40} strokeWidth={3} /> : <Ban size={40} strokeWidth={3} />}
              </motion.div>
          </div>
                            ...
                            {isFullSlot && (
                                <div className="absolute inset-0 flex items-center justify-center z-20">
                                    ...
                                    <motion.div
                                        ...
                                        className="absolute text-[8rem] sm:text-[11rem] drop-shadow-lg"
                                    >
                                    ...
                                    <motion.div
                                        ...
                                        animate={{ scale: 0.45, x: -60, y: 0, rotate: -15 }}
                                        className="absolute text-[8rem] sm:text-[11rem] drop-shadow-lg"
                                    >
                                        {currentScenario.object}
                                    </motion.div>
                                    ...
                                    <motion.div
                                        initial={{ scale: 0, y: 50 }}
                                        animate={{ scale: 0.45, x: -30, y: 40, rotate: -5 }}
                                        className="absolute text-[8rem] sm:text-[11rem] drop-shadow-lg z-30"
                                    >
                                        {currentScenario.object}
                                    </motion.div>
