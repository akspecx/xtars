/**
 * UnderstandingOfBig.tsx — Visual Logic module (BIG/SMALL)
...
const MSG: AvatarMessages = {
  ...
  wrong:              `Look for the bigger one! 👀`,
};

const DEFINITION   = `BIG means something takes up a LOT of space — it is wide, heavy, and hard to miss! 🐘`;
const ACCENT       = '#2D6A4F';
