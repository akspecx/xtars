...
interface MemoryLandingPageProps {
  onBack?: () => void;
  theme?: any;
  title?: string;
  icon?: string;
...
const MemoryLandingPage: React.FC<MemoryLandingPageProps> = ({ onBack }) => {
  const navigate = useNavigate();
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
                   <div className="text-center md:text-left max-w-2xl text-[#3e2723]">
                      ...
                      <p className="text-xs sm:text-sm font-bold tracking-[0.05em] leading-relaxed opacity-60">
                        Strengthen your memory with matching games. Pick a game to challenge yourself!
                      </p>
                   </div>
...
export default MemoryLandingPage;