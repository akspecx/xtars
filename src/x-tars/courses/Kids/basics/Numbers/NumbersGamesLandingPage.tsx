...
const numberGameData: NumberGameCard[] = [
  ...
  { id: "more-or-less", title: "More-or-Less Market", subtitle: "More, fewer, or the same? (Age 3–4)", icon: "🧺", gradient: "from-amber-500 to-rose-500", path: "/games/numbers/more-or-less-market" },
