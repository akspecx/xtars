...
interface NumbersGamesLandingPageProps {
  onBack?: () => void;
  theme?: any;
  title?: string;
  icon?: string;
...
const NumbersGamesLandingPage: React.FC<NumbersGamesLandingPageProps> = ({ onBack }) => {
  const navigate = useNavigate();
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
                   <div className="text-center md:text-left max-w-2xl text-[#3e2723]">
                      ...
                      <p className="text-xs sm:text-sm font-bold tracking-[0.05em] leading-relaxed opacity-60">
                        Master counting and numbers with engaging activities. Pick a game to begin!
                      </p>
                   </div>
