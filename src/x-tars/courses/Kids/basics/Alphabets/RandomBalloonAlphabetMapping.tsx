...
const AlphabetBalloonGame = () => {
  ...
  // --- Render UI ---
  return (
    <div className={`w-full min-h-screen h-full relative overflow-hidden font-sans pb-4 transition-colors duration-500 ${theme === 'light' ? 'bg-gradient-to-b from-blue-200 to-blue-400' : 'bg-gray-900'}`}>
      ...
      <div className="sticky top-0 left-0 right-0 z-10 bg-blue-500/80 backdrop-blur-sm p-4 shadow-xl rounded-b-xl dark:bg-gray-800/90 dark:shadow-2xl transition-colors duration-500">
        ...
        <div className="flex justify-end mb-4">
          <button
            onClick={toggleTheme}
            className="p-2 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 shadow-md hover:scale-105 transition-transform"
            aria-label="Toggle Theme"
          >
            {theme === 'light' ? (
              // Moon icon (Dark Mode)
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z" /></svg>
            ) : (
              // Sun icon (Light Mode)
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 12h1m8 -9v1m8 8h1m-9 8v1m-6.4 -12.4l.7 .7m12.1 -.7l-.7 .7m0 11.4l.7 .7m-12.1 -.7l-.7 .7" /></svg>
            )}
          </button>
        </div>
