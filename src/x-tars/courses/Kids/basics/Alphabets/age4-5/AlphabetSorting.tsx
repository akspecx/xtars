...
const AlphabetSorting: React.FC = () => {
  ...
  const handleTouchMove = (e: React.TouchEvent<HTMLDivElement>) => {
    // Prevent page from scrolling while "dragging" a letter
    e.preventDefault();
    e.stopPropagation();
  };
  ...
  const handleTouchEnd = (e: React.TouchEvent<HTMLDivElement>) => {
    ...
    if (elementBelow) {
      const binElement = elementBelow.closest('[data-bin-type]') as HTMLElement | null;
      const binTypeAttr = binElement?.getAttribute('data-bin-type') as
        | 'vowel'
        | 'consonant'
        | 'curves'
        | 'straight'
