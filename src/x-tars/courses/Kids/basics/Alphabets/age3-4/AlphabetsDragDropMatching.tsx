    ...
    <div className={`min-h-screen transition-colors duration-300 ${isDarkMode
      ...
      <div className="max-w-7xl mx-auto p-3 sm:p-4 md:p-6 rounded-2xl sm:rounded-3xl">
        ...
        <div className="text-center mb-4 sm:mb-6">
          <h1 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 ${isDarkMode
          ...
          <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6">
            <div className={`rounded-full px-3 sm:px-4 md:px-6 py-1 sm:py-2 shadow-lg ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white'
              }`}>
        ...
        <div className="space-y-4 sm:space-y-6 md:space-y-8">
              ...
              >
                {!draggedLetter ? (
                  <div className="text-center">
                    ...
                    <p className={`text-xs sm:text-sm md:text-base mt-2 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'
                      }`}>
                  ...
                  <div className="text-center">
                    ...
                    {showFeedback && (
                      <div className={`text-sm sm:text-base md:text-lg font-bold mt-2 ${isCorrect ? 'text-green-600' : 'text-red-600'
                        }`}>
          ...
          <div className={`rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-6 shadow-2xl border-4 mx-2 ${isDarkMode
              ? 'bg-gray-800 border-purple-600'
              : 'bg-white border-gradient-to-r from-purple-400 to-pink-400'
            }`}>
            <div className="text-center mb-3 sm:mb-4">
              <h2 className={`text-base sm:text-lg md:text-xl lg:text-2xl font-bold ${isDarkMode ? 'text-gray-200' : 'text-gray-700'
                }`}>
        ...
        {/* Instructions */}
        <div className={`mt-6 sm:mt-8 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-lg border-2 mx-2 ${isDarkMode
            ? 'bg-gray-800 border-purple-600'
            : 'bg-white border-purple-200'
          }`}>
          <h3 className={`text-base sm:text-lg font-bold text-center mb-2 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'
            }`}>
            🎮 How to Play
          </h3>
          <div className={`text-center space-y-1 text-xs sm:text-sm md:text-base ${isDarkMode ? 'text-gray-300' : 'text-gray-600'
            }`}>
